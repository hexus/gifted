...
(lib.Pistol = function() {
	...
	this.shape_35.setTransform(2.2,-2.5);
...
(lib.ElvenDagger = function() {
	...
	this.shape_41.graphics.beginFill("#DCB67C").beginStroke().moveTo(0.3,-0.4).curveTo(0.2,-0.4,0.3,-0.5).lineTo(0.4,-1.1).curveTo(0.8,-0.4,0.8,1).curveTo(0.6,1.1,0.1,1).curveTo(-0.3,0.8,-0.4,0.7).curveTo(-0.9,-0.2,-0.7,-0.4).lineTo(-0.7,-0.4).curveTo(-0.6,-0.2,-0.5,-0.2).curveTo(-0.2,0.1,-0.1,0.1).closePath();
	this.shape_41.setTransform(0.3,3.7);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.beginFill("#493036").beginStroke().moveTo(0.6,-2.8).lineTo(0.5,-1.8).curveTo(0.4,-0.6,0.4,-0.1).lineTo(0.5,1.2).curveTo(0.5,1.7,0.3,2.5).lineTo(0.1,2.8).lineTo(-0.3,2.6).curveTo(-0.3,1.8,-0.6,-2.4).curveTo(0.2,-2.5,0.6,-2.8).closePath();
	this.shape_42.setTransform(0.1,0.6);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.beginFill("#DADADA").beginStroke().moveTo(1.1,4.5).lineTo(1.2,4.5).lineTo(1.1,4.6).lineTo(1.1,4.6).curveTo(1.3,5.1,1.4,5.2).lineTo(1.5,5.3).curveTo(1.3,5.4,1.1,5.5).curveTo(0.9,5.7,0.9,6).curveTo(0.6,5.8,0.1,6.2).curveTo(-0.1,6.2,-0.4,6.3).curveTo(-0.1,5.3,-0.2,1.4).curveTo(-0.4,-3.4,-1.5,-4.3).curveTo(-1.2,-5.3,-1.4,-6.3).curveTo(-0.7,-5.5,-0.2,-4).curveTo(-0,-3.4,0.4,-1.4).curveTo(0.8,-0.3,0.8,1.6).curveTo(0.7,2.7,0.7,3.2).curveTo(0.7,4.1,1,4.6).lineTo(1.1,4.5).closePath().moveTo(0.1,-0.8).curveTo(0.2,-1.9,0.1,-2.2).lineTo(-0.1,-2.3).curveTo(-0.3,-2.5,-0.4,-3.1).curveTo(-0.5,-4,-0.6,-4.4).curveTo(-0.7,-4.1,-0.5,-3.3).curveTo(-0.4,-2.6,-0.2,-2.2).lineTo(-0,-2.1).lineTo(-0,-2).curveTo(0.1,-1.7,0.1,-1).curveTo(-0,0,0,0.2).lineTo(0.4,0.5).lineTo(0.5,0.4).curveTo(0.1,0.2,0.1,-0.8).closePath().moveTo(0.2,5).lineTo(0.5,5.2).curveTo(0.3,5.4,0.3,5.5).lineTo(0.6,5.3).lineTo(0.6,5.1).lineTo(0.2,4.8).curveTo(-0,5.2,-0.1,5.8).lineTo(0.2,6).lineTo(0.3,5.9).curveTo(0.1,5.9,0.1,5.6).curveTo(0.1,5.2,0.2,5).closePath().moveTo(0.1,4.1).lineTo(0.2,4.1).lineTo(0.5,3.9).lineTo(0.3,3.8).lineTo(0.1,3.9).curveTo(0.7,2.5,0.1,1.2).curveTo(0.3,2.2,0.3,2.7).curveTo(0,4,-0.2,4.6).curveTo(0,4.3,0.1,4.1).closePath().moveTo(-0.8,-3.7).lineTo(-0.7,-3.8).curveTo(-0.8,-4.3,-1,-5.3).curveTo(-1.2,-4,-0.8,-3.7).closePath();
	this.shape_43.setTransform(0,-8.4);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.beginFill("#000000").beginStroke().moveTo(-1.1,-8.8).curveTo(-0.9,-7.7,-1.1,-6.8).curveTo(-0,-5.8,0.2,-1).curveTo(0.2,2.9,-0,3.8).curveTo(0.3,3.8,0.4,3.7).curveTo(0.9,3.3,1.2,3.6).curveTo(1.3,3.3,1.5,3).curveTo(1.6,2.9,1.8,2.8).lineTo(1.7,2.8).curveTo(1.6,2.7,1.5,2.1).lineTo(1.4,2.1).lineTo(1.5,2.1).lineTo(1.5,2.1).curveTo(1.5,1.6,1.4,0.8).curveTo(1.5,-0.7,1.6,-1.2).curveTo(2,-2.6,1.4,-5).curveTo(0.5,-8.4,-1.6,-10.6).curveTo(-1.3,-9.5,-1.2,-9).lineTo(-1.1,-8.9).curveTo(-1.1,-8.9,-1.1,-8.8).closePath().moveTo(1.9,-3.1).curveTo(2.1,-1.8,1.9,-1.1).curveTo(1.8,-0.7,1.8,-0).curveTo(1.9,0.8,1.9,0.9).curveTo(1.6,2.2,2,2.8).lineTo(2,2.9).curveTo(2,3,2,3).lineTo(1.6,3.2).curveTo(1.4,3.5,1.4,3.9).lineTo(1.4,3.9).curveTo(1.4,4.2,1.3,4.8).lineTo(1.1,6.1).lineTo(1.3,8.2).lineTo(1.4,8.2).lineTo(1.8,10.8).curveTo(1.3,11.4,0.2,10.6).curveTo(-0.4,10.1,-0.3,9.3).lineTo(-0,9).curveTo(-0.3,7.8,-0.4,3.9).curveTo(-0.3,3.9,-0.2,3.9).curveTo(-0.1,0.1,-0.2,-1.9).curveTo(-0.2,-5.2,-1.5,-6.8).curveTo(-1.4,-6.8,-1.4,-6.8).curveTo(-1.4,-7,-1.4,-7.6).curveTo(-1.5,-8.7,-1.5,-9).curveTo(-1.5,-9.1,-1.8,-10).curveTo(-2,-10.5,-1.9,-10.8).lineTo(-2,-10.9).lineTo(-2,-11).lineTo(-1.9,-11).lineTo(-1.8,-11.1).lineTo(-1.8,-11).curveTo(-1.6,-11,-1.5,-10.9).curveTo(0.3,-9.3,1.7,-4.9).curveTo(1.8,-4.7,1.8,-4).curveTo(1.8,-3.2,1.9,-3.1).closePath().moveTo(1.1,3.8).curveTo(0.6,4.1,-0.1,4.2).curveTo(0.1,8.4,0.2,9.2).lineTo(0.5,9.4).lineTo(0.8,9.1).curveTo(1,8.3,0.9,7.8).lineTo(0.9,6.5).curveTo(0.8,6,1,4.8).closePath().moveTo(1,9.3).lineTo(0.6,9.8).curveTo(0.5,9.8,0.2,9.5).curveTo(0.1,9.5,0.1,9.3).lineTo(0,9.3).curveTo(-0.1,9.5,0.4,10.4).curveTo(0.5,10.5,0.9,10.7).curveTo(1.4,10.8,1.5,10.7).curveTo(1.5,9.3,1.2,8.6).lineTo(1,9.2).curveTo(1,9.3,1,9.3).closePath();
	this.shape_44.setTransform(-0.3,-5.9);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.beginFill("#CCCCCC").beginStroke().moveTo(1.4,5.6).lineTo(1.4,5.5).lineTo(1.3,5.7).curveTo(1,5.1,1,4.3).curveTo(1,3.8,1,2.7).curveTo(1,0.8,0.7,-0.4).curveTo(0.3,-2.4,0.1,-3).curveTo(-0.4,-4.4,-1.1,-5.3).curveTo(-1.2,-5.4,-1.2,-5.4).lineTo(-1.2,-5.5).curveTo(-1.4,-6,-1.7,-7.1).curveTo(0.5,-4.9,1.4,-1.5).curveTo(1.9,0.9,1.5,2.3).curveTo(1.4,2.8,1.3,4.3).curveTo(1.4,5.1,1.4,5.6).closePath().moveTo(0.4,0.3).curveTo(0.4,1.2,0.8,1.5).lineTo(0.7,1.6).lineTo(0.3,1.2).curveTo(0.3,1,0.4,0.1).curveTo(0.4,-0.7,0.3,-1).lineTo(0.3,-1.1).lineTo(0.1,-1.2).curveTo(-0.1,-1.6,-0.2,-2.3).curveTo(-0.4,-3,-0.3,-3.3).curveTo(-0.2,-3,-0.1,-2).curveTo(0,-1.5,0.2,-1.3).lineTo(0.4,-1.1).curveTo(0.5,-0.9,0.4,0.3).closePath().moveTo(0.4,5.1).curveTo(0.3,5.4,0.1,5.7).curveTo(0.3,5.1,0.6,3.7).curveTo(0.6,3.3,0.4,2.2).curveTo(1,3.6,0.4,5).lineTo(0.6,4.8).lineTo(0.8,4.9).lineTo(0.5,5.2).closePath().moveTo(0.5,6.1).curveTo(0.4,6.3,0.4,6.6).curveTo(0.4,6.9,0.6,7).lineTo(0.5,7.1).lineTo(0.2,6.8).curveTo(0.3,6.2,0.5,5.9).lineTo(0.8,6.2).lineTo(0.9,6.3).lineTo(0.6,6.6).curveTo(0.6,6.4,0.8,6.2).closePath().moveTo(-0.5,-2.7).curveTo(-0.9,-2.9,-0.7,-4.3).curveTo(-0.6,-3.3,-0.4,-2.8).closePath();
	this.shape_45.setTransform(-0.3,-9.4);

	this.addChild(this.shape_45,this.shape_44,this.shape_43,this.shape_42,this.shape_41);
}).prototype = p = new cjs.Container();
...
(lib.Katana_1 = function() {
	...
	this.shape_46.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0.3,-5.8).curveTo(0.4,-5.6,0.3,-5.5).lineTo(0.3,-5.5).curveTo(-0,-5.6,-0.2,-5.5).lineTo(-0.3,-5.8).lineTo(0.1,-5.9).curveTo(0.3,-5.9,0.3,-5.8).closePath().moveTo(0.4,4.7).curveTo(0.2,5,0,5.1).lineTo(-0.4,5.2).lineTo(-0.4,5).lineTo(0.1,4.7).curveTo(0.2,4.6,0.4,4.7).closePath().moveTo(0.1,5.5).lineTo(0.1,5.7).lineTo(-0.3,6).lineTo(-0.4,6).lineTo(-0.5,5.8).lineTo(-0,5.5).closePath().moveTo(0.2,3.9).lineTo(0.4,4).lineTo(0.4,4.2).lineTo(-0.1,4.4).curveTo(-0.4,4.4,-0.4,4.3).curveTo(-0.4,4.2,-0.3,4.1).closePath().moveTo(-0,2.4).curveTo(0.2,2.3,0.4,2.5).lineTo(0,2.8).lineTo(-0.3,2.9).curveTo(-0.5,2.6,-0,2.4).closePath().moveTo(0.1,3.1).curveTo(0.2,3,0.3,3.1).curveTo(0.2,3.4,0.1,3.5).lineTo(-0.3,3.5).lineTo(-0.4,3.4).closePath().moveTo(0.4,1.9).lineTo(-0.1,2).lineTo(-0.2,2).lineTo(-0.3,1.8).lineTo(0.2,1.6).lineTo(0.4,1.7).closePath().moveTo(0.5,0.6).lineTo(0.4,0.8).lineTo(-0,1.2).lineTo(-0.3,1.3).curveTo(-0.4,0.9,0,0.7).curveTo(0.4,0.5,0.5,0.6).closePath().moveTo(0.3,-0.2).lineTo(0.5,-0.1).curveTo(0.5,0,0.5,0.1).lineTo(-0.1,0.4).lineTo(-0.2,0.3).curveTo(-0.2,0.1,-0.2,0.1).closePath().moveTo(0.4,-1.6).lineTo(-0.1,-1.3).lineTo(-0.2,-1.2).lineTo(-0.3,-1.5).lineTo(0.3,-1.8).lineTo(0.4,-1.7).closePath().moveTo(0.2,-1).lineTo(0.4,-0.9).lineTo(0.4,-0.7).lineTo(-0.1,-0.5).lineTo(-0.2,-0.5).lineTo(-0.3,-0.7).closePath().moveTo(0.1,-3.5).lineTo(0.3,-3.5).curveTo(0.1,-3.1,0.1,-3.1).lineTo(-0.2,-3).curveTo(-0.1,-3.4,0.1,-3.5).closePath().moveTo(0.3,-2.6).lineTo(0.4,-2.4).lineTo(-0.2,-2.1).lineTo(-0.2,-2.2).lineTo(-0.3,-2.4).lineTo(0.2,-2.8).closePath().moveTo(0.1,-5.1).curveTo(0.3,-5.1,0.3,-5).curveTo(0.4,-5,0.3,-4.8).lineTo(-0.2,-4.7).lineTo(-0.3,-4.9).closePath().moveTo(0.4,-4.1).lineTo(-0.1,-3.8).lineTo(-0.2,-3.9).lineTo(-0.3,-4.2).lineTo(0.3,-4.4).lineTo(0.4,-4.3).closePath();
	this.shape_46.setTransform(0.1,2.1);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.beginFill("#6A6ABD").beginStroke().moveTo(0.3,-6).curveTo(0.2,-6.2,0,-6.2).lineTo(-0.4,-6).lineTo(-0.3,-5.8).curveTo(-0.1,-5.9,0.2,-5.8).lineTo(0.3,-5.8).curveTo(0.4,-5.9,0.3,-6).closePath().moveTo(0.7,-6.3).curveTo(0.7,-5.9,0.6,-5.2).curveTo(0.6,-3.7,0.7,-3).curveTo(0.9,-2.2,0.9,-1.2).curveTo(0.8,-0.7,0.7,0.4).lineTo(0.6,4.1).curveTo(0.6,4.6,0.7,5.9).curveTo(0.7,6.1,0.6,6.4).curveTo(0.4,6.3,0,6.2).curveTo(-0.5,6.2,-0.9,6.1).lineTo(-0.7,-3.3).curveTo(-0.7,-5.7,-0.6,-6.3).curveTo(-0.3,-6.3,-0.2,-6.3).curveTo(0.1,-6.5,0.6,-6.2).closePath().moveTo(0.4,-4.4).lineTo(0.3,-4.6).lineTo(0.2,-4.7).lineTo(-0.3,-4.4).lineTo(-0.2,-4.2).lineTo(-0.1,-4.1).closePath().moveTo(0,-5.4).lineTo(-0.4,-5.2).lineTo(-0.2,-5).lineTo(0.3,-5.1).curveTo(0.3,-5.3,0.3,-5.3).curveTo(0.3,-5.4,0,-5.4).closePath().moveTo(0.2,-2.9).lineTo(0.2,-3.1).lineTo(-0.4,-2.7).lineTo(-0.3,-2.5).lineTo(-0.2,-2.4).lineTo(0.3,-2.7).closePath().moveTo(0,-3.8).curveTo(-0.2,-3.7,-0.2,-3.3).lineTo(0,-3.4).curveTo(0.1,-3.4,0.2,-3.8).closePath().moveTo(0.2,-1.3).lineTo(-0.4,-1).lineTo(-0.2,-0.8).lineTo(-0.2,-0.8).lineTo(0.3,-1).lineTo(0.3,-1.2).closePath().moveTo(0.4,-1.9).lineTo(0.4,-2).lineTo(0.2,-2.1).lineTo(-0.4,-1.8).lineTo(-0.3,-1.5).lineTo(-0.1,-1.6).closePath().moveTo(0.3,-0.5).lineTo(-0.3,-0.2).curveTo(-0.2,-0.2,-0.3,0).lineTo(-0.2,0.1).lineTo(0.4,-0.2).curveTo(0.5,-0.3,0.4,-0.4).closePath().moveTo(0.4,0.3).curveTo(0.3,0.2,-0,0.4).curveTo(-0.5,0.6,-0.3,1).lineTo(-0.1,0.9).lineTo(0.4,0.5).closePath().moveTo(0.3,1.6).lineTo(0.4,1.4).lineTo(0.2,1.3).lineTo(-0.4,1.5).lineTo(-0.3,1.7).lineTo(-0.1,1.8).closePath().moveTo(0,2.8).lineTo(-0.4,3.1).lineTo(-0.3,3.2).lineTo(0,3.2).curveTo(0.2,3.1,0.2,2.8).curveTo(0.1,2.8,0,2.8).closePath().moveTo(-0.1,2.1).curveTo(-0.5,2.3,-0.3,2.6).lineTo(-0,2.5).lineTo(0.3,2.2).curveTo(0.1,2,-0.1,2.1).closePath().moveTo(0.2,3.6).lineTo(-0.3,3.8).curveTo(-0.5,3.9,-0.5,4).curveTo(-0.5,4.1,-0.2,4.1).lineTo(0.3,3.9).lineTo(0.3,3.7).closePath().moveTo(0.1,5.3).lineTo(-0.1,5.2).lineTo(-0.6,5.5).lineTo(-0.5,5.7).lineTo(-0.4,5.7).lineTo(0.1,5.4).closePath().moveTo(0.4,4.4).curveTo(0.2,4.3,0.1,4.4).lineTo(-0.5,4.7).lineTo(-0.4,4.9).lineTo(-0,4.8).curveTo(0.2,4.7,0.4,4.4).closePath();
	this.shape_47.setTransform(0.1,2.3);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.beginFill("#E0AD22").beginStroke().moveTo(-0,-7.6).lineTo(-0.1,-7.4).lineTo(0.2,-7.4).lineTo(0.2,-7.6).lineTo(0.2,-7.7).closePath().moveTo(1.9,-6.4).curveTo(1.5,-6.5,1.2,-6.4).curveTo(1,-6.3,0.9,-5.9).curveTo(0.9,-5.7,1,-5.4).lineTo(0.9,-5.4).lineTo(0.9,-5.4).curveTo(0.7,-5.4,0.2,-5.5).curveTo(-0.2,-5.4,-0.6,-5.5).curveTo(-0.7,-5.6,-0.8,-5.9).lineTo(-1,-6.4).curveTo(-1.1,-6.5,-1.4,-6.4).curveTo(-1.6,-6.3,-1.9,-6.5).lineTo(-1.5,-6.7).lineTo(-0.8,-6.6).curveTo(-0.7,-6.7,-0.7,-7.4).curveTo(-0.6,-7.9,-0.6,-8.2).curveTo(-0.5,-8.2,-0.6,-8.5).curveTo(-0.2,-8.5,0.7,-8.3).lineTo(0.8,-6.9).curveTo(0.9,-6.6,1.3,-6.6).curveTo(1.8,-6.5,1.9,-6.4).closePath().moveTo(0.4,-6.5).lineTo(0.3,-6.2).lineTo(0.5,-6.2).lineTo(0.6,-6.4).lineTo(0.5,-6.5).closePath().moveTo(0.5,-6.9).lineTo(0.6,-7).lineTo(0.5,-7.2).curveTo(0.5,-7.2,0.4,-7.2).curveTo(0.3,-7.2,0.3,-7).closePath().moveTo(0.2,-5.9).lineTo(0.2,-6).lineTo(0,-6).lineTo(0,-5.8).lineTo(0.2,-5.8).closePath().moveTo(0.4,8.4).curveTo(0.4,8.4,0.3,8.5).curveTo(0.2,8.3,-0,8.4).curveTo(-0.1,8.3,-0.2,8.4).lineTo(-0.3,8.4).curveTo(-0.4,8.4,-0.4,8.4).curveTo(-0.5,8.4,-0.6,8.3).lineTo(-0.9,7.8).lineTo(-0.8,7.6).curveTo(-0.6,7.6,-0.1,7.6).curveTo(0.3,7.6,0.7,7.8).curveTo(0.6,8.2,0.5,8.4).closePath().moveTo(-0.3,-6.7).curveTo(-0.5,-6.6,-0.4,-6.3).lineTo(-0.2,-6.4).curveTo(-0.1,-6.5,-0.2,-6.5).closePath().moveTo(-0.2,-7).curveTo(-0.2,-7.1,-0.2,-7.2).lineTo(-0.3,-7.3).curveTo(-0.5,-7.2,-0.4,-6.9).closePath();
	this.shape_48.setTransform(0.1,1.1);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.beginFill("#BA8E1B").beginStroke().moveTo(-0.1,-0.9).lineTo(0.1,-0.9).lineTo(0.1,-0.8).lineTo(0.1,-0.7).lineTo(-0.2,-0.6).closePath().moveTo(0.1,0.8).lineTo(0.1,1).lineTo(-0.1,1).lineTo(-0.1,0.7).lineTo(0.1,0.7).closePath().moveTo(0.4,-0.2).lineTo(0.2,-0.3).curveTo(0.2,-0.4,0.3,-0.5).curveTo(0.4,-0.5,0.4,-0.4).lineTo(0.5,-0.3).closePath().moveTo(0.3,0.2).lineTo(0.4,0.2).lineTo(0.5,0.4).lineTo(0.4,0.5).lineTo(0.2,0.6).closePath().moveTo(-0.3,-0.3).lineTo(-0.5,-0.2).curveTo(-0.6,-0.4,-0.4,-0.5).lineTo(-0.3,-0.4).curveTo(-0.3,-0.4,-0.3,-0.3).closePath().moveTo(-0.4,0.1).lineTo(-0.3,0.2).curveTo(-0.2,0.3,-0.3,0.4).lineTo(-0.5,0.4).curveTo(-0.6,0.2,-0.4,0.1).closePath();
	this.shape_49.setTransform(0.1,-5.6);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.beginFill("#AAAAAA").beginStroke().moveTo(1.3,9.9).curveTo(1.3,10.4,1.3,11).curveTo(1.6,12.8,1.6,14.8).curveTo(1.5,15.9,1.3,17.7).lineTo(1.3,17.6).lineTo(1.4,14).curveTo(1,10.8,1,9.9).curveTo(1,9.7,1,9.6).curveTo(1.1,8.5,1,5.6).curveTo(0.9,3.9,0.8,1.7).curveTo(0.8,1.6,0.8,1.4).curveTo(0.7,0.3,0.4,-2.2).curveTo(0.2,-4.5,-0.2,-7.6).curveTo(-1,-14.7,-1.6,-17.7).lineTo(-1.6,-17.7).lineTo(-1.4,-17.4).curveTo(-0,-8,0.6,-2.3).curveTo(0.6,-2.2,0.7,-1.9).curveTo(0.8,-0.2,1,1.4).curveTo(1.1,3.5,1.2,5.4).curveTo(1.3,7.8,1.3,9.9).closePath();
	this.shape_50.setTransform(-1.2,-25.9);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.beginFill("#D8D8D8").beginStroke().moveTo(1.3,10).curveTo(1.3,8,1.2,5.6).curveTo(1.1,3.7,1,1.6).curveTo(0.8,-0,0.7,-1.8).curveTo(0.6,-2,0.6,-2.2).curveTo(-0,-7.9,-1.4,-17.2).lineTo(-1.6,-17.5).lineTo(-1.6,-17.5).curveTo(-1,-14.5,-0.2,-7.5).curveTo(0.2,-4.3,0.4,-2.1).curveTo(0.7,0.5,0.8,1.6).curveTo(0.8,1.7,0.8,1.8).curveTo(0.9,4.1,1,5.7).curveTo(1.1,8.6,1,9.8).curveTo(1,9.9,1,10).curveTo(1,10.9,1.4,14.2).lineTo(1.3,17.8).lineTo(1.3,17.8).curveTo(1.5,16,1.6,14.9).curveTo(1.6,13,1.3,11.1).curveTo(1.3,10.6,1.3,10).closePath().moveTo(1.6,10).curveTo(1.8,11.7,1.9,14.3).curveTo(1.9,14.4,1.9,16.5).curveTo(1.8,17.9,2,18.4).curveTo(1.7,18.4,1.4,18.4).curveTo(1,18.4,0.8,18.5).curveTo(0.7,17.6,0.7,15.6).curveTo(0.5,10.9,0.5,10).lineTo(0.5,10).curveTo(0.5,8.5,0.3,6.1).curveTo(0.2,4.1,-0,1.6).curveTo(-0.1,1.1,-0.1,0.6).curveTo(-0.2,-0.6,-0.3,-1.7).curveTo(-1.6,-16.6,-2,-18.5).curveTo(-1.6,-18.2,-1.4,-17.8).curveTo(-1,-17.1,-0.8,-15.2).curveTo(-0.6,-13.2,-0.6,-13).curveTo(-0.2,-11,0,-8.7).curveTo(0.6,-5,0.7,-3.8).lineTo(1.1,0.6).curveTo(1.1,1,1.1,1.6).curveTo(1.3,3,1.4,5.4).curveTo(1.4,5.5,1.4,5.5).curveTo(1.4,8.5,1.6,9.9).curveTo(1.6,10,1.6,10).closePath();
	this.shape_51.setTransform(-1.2,-26);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.beginFill("#000000").beginStroke().moveTo(1.2,-2.9).curveTo(1.3,0.6,1.3,1.5).curveTo(1.5,3.2,1.7,6.5).curveTo(1.7,9.4,1.6,10).curveTo(1.7,10,1.7,10).lineTo(1.9,11.6).curveTo(1.9,11.7,2.4,11.8).curveTo(2.9,11.9,3,12).curveTo(3.1,12.3,2.8,12.5).lineTo(2.5,12.5).curveTo(2.3,12.5,2.1,12.6).curveTo(2.1,13.4,1.9,13.5).curveTo(2.1,14,2,15.2).curveTo(1.9,16.9,2,17.3).curveTo(2.1,18,2,19).curveTo(1.9,19.6,1.9,20.7).curveTo(1.8,21.2,1.9,24.2).curveTo(1.8,26.7,1.3,27.3).lineTo(1.3,27.4).lineTo(0.9,27.5).lineTo(0.8,27.5).curveTo(0.6,27.5,0.4,27.5).lineTo(0.3,27.5).lineTo(0.3,27.4).curveTo(0.1,27.3,-0.1,27.2).curveTo(-0.5,26.4,-0.5,25.7).curveTo(-0.4,25,-0.5,24.7).curveTo(-0.5,23.6,-0.4,23).curveTo(-0.2,21.7,-0.3,19.7).curveTo(-0.4,18.6,-0.3,15.8).lineTo(-0.2,13.5).lineTo(-0.4,13).lineTo(-0.6,12.5).lineTo(-0.9,12.6).curveTo(-1.2,12.7,-1.3,12.5).curveTo(-1.6,12.1,-1.5,12).lineTo(-1.4,11.8).lineTo(-0.4,11.7).curveTo(-0.4,11,-0.4,10.7).curveTo(-0.4,10.1,-0.1,9.9).curveTo(-0.4,4.6,-0.5,1.5).curveTo(-0.5,1.3,-0.5,1.1).curveTo(-0.4,-0.5,-0.6,-2.3).curveTo(-0.7,-4.5,-0.9,-7).curveTo(-1,-7.7,-1.1,-8.5).curveTo(-1.2,-9.1,-1.2,-10.1).curveTo(-1.5,-12.7,-2,-17.9).lineTo(-3,-27.5).curveTo(-2.2,-27.7,-1.6,-26.5).curveTo(-1.1,-25.4,-0.2,-17).lineTo(0.9,-7.2).curveTo(0.9,-7.1,0.9,-7).curveTo(1.1,-5.7,1.2,-3.2).curveTo(1.1,-3.1,1.2,-2.9).closePath().moveTo(1,1.5).curveTo(1,1.4,1,1.4).curveTo(0.8,-0.1,0.8,-3).curveTo(0.8,-3.1,0.8,-3.2).curveTo(0.7,-5.5,0.5,-7).curveTo(0.5,-7.5,0.5,-7.9).lineTo(0.1,-12.4).curveTo(-0,-13.6,-0.6,-17.2).curveTo(-0.8,-19.5,-1.2,-21.5).curveTo(-1.2,-21.8,-1.4,-23.7).curveTo(-1.6,-25.7,-2,-26.4).curveTo(-2.2,-26.8,-2.6,-27).curveTo(-2.2,-25.2,-0.9,-10.3).curveTo(-0.8,-9.1,-0.7,-7.9).curveTo(-0.7,-7.4,-0.6,-7).curveTo(-0.4,-4.5,-0.3,-2.5).curveTo(-0.1,-0,-0.1,1.4).lineTo(-0.1,1.5).curveTo(-0.1,2.3,0.1,7).curveTo(0.1,9.1,0.2,9.9).curveTo(0.4,9.9,0.8,9.9).curveTo(1.1,9.9,1.4,9.9).curveTo(1.2,9.3,1.3,7.9).curveTo(1.3,5.8,1.3,5.7).curveTo(1.2,3.2,1,1.5).closePath().moveTo(2.6,12.2).curveTo(2.5,12.1,2,12).curveTo(1.6,12,1.5,11.7).lineTo(1.4,10.3).curveTo(0.5,10.1,0.1,10.2).curveTo(0.2,10.4,0.1,10.5).curveTo(0.1,10.7,0,11.2).curveTo(-0,12,-0.1,12).lineTo(-0.8,12).lineTo(-1.2,12.2).curveTo(-0.9,12.3,-0.7,12.2).curveTo(-0.4,12.2,-0.3,12.3).lineTo(-0.1,12.7).curveTo(-0,13,0.1,13.2).curveTo(0.5,13.2,0.9,13.2).curveTo(1.4,13.2,1.6,13.3).lineTo(1.6,13.2).lineTo(1.7,13.2).curveTo(1.6,13,1.6,12.7).curveTo(1.7,12.4,1.9,12.3).curveTo(2.2,12.1,2.6,12.2).closePath().moveTo(1.5,13.6).lineTo(1.4,13.7).curveTo(0.9,13.4,0.6,13.6).curveTo(0.5,13.6,0.2,13.6).curveTo(0.1,14.2,0.1,16.6).lineTo(-0.1,26).curveTo(0.3,26.1,0.8,26.1).curveTo(1.2,26.2,1.4,26.3).curveTo(1.5,26,1.5,25.8).curveTo(1.4,24.5,1.4,24).lineTo(1.5,20.3).curveTo(1.6,19.2,1.7,18.7).curveTo(1.7,17.7,1.5,16.9).curveTo(1.4,16.2,1.4,14.7).curveTo(1.5,14,1.5,13.6).closePath().moveTo(1.1,27.1).lineTo(1.2,27.1).curveTo(1.3,26.9,1.4,26.5).curveTo(1,26.3,0.6,26.3).curveTo(0.1,26.2,-0.1,26.3).lineTo(-0.2,26.4).lineTo(0.1,27).curveTo(0.2,27,0.3,27).curveTo(0.3,27.1,0.4,27).lineTo(0.5,27.1).curveTo(0.6,27,0.7,27).curveTo(0.9,27,1,27.1).curveTo(1.1,27.1,1.1,27.1).closePath();
	this.shape_52.setTransform(-0.6,-17.5);

	this.addChild(this.shape_52,this.shape_51,this.shape_50,this.shape_49,this.shape_48,this.shape_47,this.shape_46);
}).prototype = p = new cjs.Container();
...
(lib.giftedclientchatBubble = function(mode,startPosition,loop) {
	...
	this.shape_61.setTransform(-3.9,-59.7);
	...
	this.shape_64.setTransform(-1.8,-70.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_56},{t:this.shape_55}]}).to({state:[{t:this.shape_58},{t:this.shape_57}]},1).to({state:[{t:this.shape_60},{t:this.shape_59}]},1).to({state:[{t:this.shape_62},{t:this.shape_61}]},1).to({state:[{t:this.shape_64},{t:this.shape_63}]},1).wait(1));
...
(lib.mcCharScreen_bg = function() {
	...
	this.shape_65.graphics.beginFill("#523D83").beginStroke().moveTo(303.1,-139.2).lineTo(-303.1,-139.2).curveTo(-315.1,-139.2,-323.6,-130.7).curveTo(-332.1,-122.1,-332.1,-110).lineTo(-332.1,110.1).curveTo(-332.1,122.1,-323.6,130.6).curveTo(-315.1,139.2,-303.1,139.2).lineTo(303.1,139.2).curveTo(315.1,139.2,323.6,130.6).curveTo(332.1,122.1,332.1,110.1).lineTo(332.1,-110).curveTo(332.1,-122.1,323.6,-130.7).curveTo(315.1,-139.2,303.1,-139.2).closePath();
	this.shape_65.setTransform(0,-139.1);
...
(lib.Border = function() {
	...
	this.shape_66.graphics.beginFill("#000000").beginStroke().moveTo(744,404.9).lineTo(-744,404.9).lineTo(-744,-404.9).lineTo(744,-404.9).closePath();
	this.shape_66.setTransform(744,405);
...
(lib.TextInput_upSkin = function() {
	...
	this.shape_67.graphics.beginFill("#FFFFFF").beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath();
	this.shape_67.setTransform(76,11);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.beginFill("#D3D5D6").beginStroke().moveTo(-75,-0.5).lineTo(75,-0.5).lineTo(75,0.5).lineTo(-75,0.5).closePath();
	this.shape_68.setTransform(76,21.5);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.beginFill("#6D6F70").beginStroke().moveTo(75.5,-0.5).lineTo(75.5,0.5).lineTo(-74.5,0.5).lineTo(-75.5,0.5).lineTo(-75.5,-0.5).closePath();
	this.shape_69.setTransform(75.5,0.5);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.beginFill("#C9CBCC").beginStroke().moveTo(75,-10).lineTo(75,-11).lineTo(76,-11).lineTo(76,11).lineTo(75,11).lineTo(75,10).closePath().moveTo(-75,10).lineTo(-75,11).lineTo(-76,11).lineTo(-76,-10).lineTo(-75,-10).closePath();
...
(lib.TextInput_disabledSkin = function() {
	...
	this.shape_71.graphics.beginFill("rgba(255,255,255,0.298)").beginStroke().moveTo(75,-10).lineTo(75,10).lineTo(-75,10).lineTo(-75,-10).closePath();
	this.shape_71.setTransform(76,11);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.beginFill("rgba(211,213,214,0.298)").beginStroke().moveTo(-75,0.5).lineTo(-75,-0.5).lineTo(75,-0.5).lineTo(75,0.5).closePath();
	this.shape_72.setTransform(76,21.5);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.beginFill("rgba(109,111,112,0.298)").beginStroke().moveTo(75.5,0.5).lineTo(-74.5,0.5).lineTo(-75.5,0.5).lineTo(-75.5,-0.5).lineTo(75.5,-0.5).closePath();
	this.shape_73.setTransform(75.5,0.5);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.beginFill("rgba(201,203,204,0.298)").beginStroke().moveTo(-76,-10).lineTo(-75,-10).lineTo(-75,10).lineTo(-75,11).lineTo(-76,11).closePath().moveTo(75,-11).lineTo(76,-11).lineTo(76,11).lineTo(75,11).lineTo(75,10).lineTo(75,-10).closePath();
...
(lib.TextArea_upSkin = function() {
	...
	this.shape_75.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-75,10).lineTo(-75,-10).lineTo(75,-10).lineTo(75,10).closePath();
	this.shape_75.setTransform(76,11);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.beginFill("#6D6F70").beginStroke().moveTo(-75.5,0.5).lineTo(-75.5,-0.5).lineTo(75.5,-0.5).lineTo(75.5,0.5).lineTo(-74.5,0.5).closePath();
	...
	this.shape_78.graphics.beginFill("#C9CBCC").beginStroke().moveTo(75,10).lineTo(75,-10).lineTo(75,-11).lineTo(76,-11).lineTo(76,11).lineTo(75,11).closePath().moveTo(-75,-10).lineTo(-75,10).lineTo(-75,11).lineTo(-76,11).lineTo(-76,-10).closePath();
...
(lib.TextArea_disabledSkin = function() {
	...
	this.shape_79.graphics.beginFill("rgba(255,255,255,0.298)").beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath();
	this.shape_79.setTransform(76,11);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.beginFill("rgba(211,213,214,0.298)").beginStroke().moveTo(75,0.5).lineTo(-75,0.5).lineTo(-75,-0.5).lineTo(75,-0.5).closePath();
	this.shape_80.setTransform(76,21.5);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.beginFill("rgba(109,111,112,0.298)").beginStroke().moveTo(-74.5,0.5).lineTo(-75.5,0.5).lineTo(-75.5,-0.5).lineTo(75.5,-0.5).lineTo(75.5,0.5).closePath();
	this.shape_81.setTransform(75.5,0.5);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.beginFill("rgba(201,203,204,0.298)").beginStroke().moveTo(75,10).lineTo(75,-10).lineTo(75,-11).lineTo(76,-11).lineTo(76,11).lineTo(75,11).closePath().moveTo(-76,-10).lineTo(-75,-10).lineTo(-75,10).lineTo(-75,11).lineTo(-76,11).closePath();
...
(lib.focusRectSkin = function() {
	...
	this.shape_83.graphics.beginFill("#6633CC").beginStroke().moveTo(41,-7).curveTo(41,-11,37,-11).lineTo(-37,-11).curveTo(-41,-11,-41,-7).lineTo(-41,7).curveTo(-41,11,-37,11).lineTo(37,11).curveTo(41,11,41,7).closePath().moveTo(40,7).curveTo(40,9.9,37.1,10).lineTo(-37.1,10).curveTo(-40,9.9,-40,7).lineTo(-40,-7).curveTo(-40,-9.9,-37.1,-10).lineTo(37.1,-10).curveTo(40,-9.9,40,-7).closePath();
...
(lib.arrowIcon = function() {
	...
	this.shape_84.graphics.beginFill("#000000").beginStroke().moveTo(3.5,-2).lineTo(-3.5,-2).lineTo(-3.5,-1).lineTo(-2.5,-1).lineTo(-2.5,0).lineTo(-1.5,0).lineTo(-1.5,1).lineTo(-0.5,1).lineTo(-0.5,2).lineTo(0.5,2).lineTo(0.5,1).lineTo(1.5,1).lineTo(1.5,0).lineTo(2.5,0).lineTo(2.5,-1).lineTo(3.5,-1).closePath();
...
(lib.ScrollTrack_skin = function() {
	...
	this.shape_85.graphics.beginFill("#585F63").beginStroke().moveTo(0.5,-74).lineTo(0.5,74).lineTo(-0.5,74).lineTo(-0.5,-74).closePath();
	this.shape_85.setTransform(0.5,74);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.beginLinearGradientFill(["#94999B","#E7E7E7"],[0,1],-6.4,7,7.5,6.8).beginStroke().moveTo(6.5,-74).lineTo(6.5,74).lineTo(-6.5,74).lineTo(-6.5,-74).closePath();
	this.shape_86.setTransform(7.5,74);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.beginFill("#585F63").beginStroke().moveTo(0.5,-74).lineTo(0.5,74).lineTo(-0.5,74).lineTo(-0.5,-74).closePath();
...
(lib.ScrollThumb_upSkin = function() {
	...
	this.shape_88.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],26.4,16,26.4,-5.9).beginStroke().moveTo(5.5,22).curveTo(5.5,25,2.7,25).lineTo(-5.5,25).lineTo(-5.5,-25).lineTo(2.7,-25).curveTo(5.5,-24.9,5.5,-22).closePath();
	this.shape_88.setTransform(6.5,26);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.beginLinearGradientFill(["#585F63","#B7BABC"],[0,1],-4.9,2.9,-4.9,-19).beginStroke().moveTo(6,-2.8).lineTo(6,-1.2).curveTo(6,2.8,2,2.8).lineTo(-6,2.8).lineTo(-6,1.8).lineTo(2.2,1.8).curveTo(5,1.8,5,-1.2).lineTo(5,-2.8).closePath();
	this.shape_89.setTransform(7,49.2);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.beginLinearGradientFill(["#585F63","#B7BABC"],[0,1],-4.9,29.1,-4.9,7.1).beginStroke().moveTo(6,23.2).lineTo(5,23.2).lineTo(5,-19.2).curveTo(5,-22.1,2.2,-22.2).lineTo(-6,-22.2).lineTo(-6,-23.2).lineTo(2,-23.2).curveTo(6,-23.2,6,-19.2).closePath();
	this.shape_90.setTransform(7,23.2);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.beginFill("rgba(255,0,0,0)").beginStroke().moveTo(1.5,-26).lineTo(1.5,26).lineTo(-1.5,26).lineTo(-1.5,-26).closePath();
...
(lib.ScrollThumb_overSkin = function() {
	...
	this.shape_92.graphics.beginFill("rgba(255,0,0,0)").beginStroke().moveTo(1.5,-26).lineTo(1.5,26).lineTo(-1.5,26).lineTo(-1.5,-26).closePath();
	...
	this.shape_95.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],26.4,16,26.4,-5.9).beginStroke().moveTo(5.5,-22).lineTo(5.5,22).curveTo(5.5,24.9,2.7,25).lineTo(-5.5,25).lineTo(-5.5,-25).lineTo(2.7,-25).curveTo(5.5,-24.9,5.5,-22).closePath();
...
(lib.ScrollThumb_downSkin = function() {
	...
	this.shape_96.graphics.beginLinearGradientFill(["#99D7FE","#D9F0FE"],[0,1],26.4,16,26.4,-5.9).beginStroke().moveTo(2.7,-25).curveTo(5.5,-24.9,5.5,-22).lineTo(5.5,22).curveTo(5.5,25,2.7,25).lineTo(-5.5,25).lineTo(-5.5,-25).closePath();
	this.shape_96.setTransform(6.5,26);

	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],-4.9,2.9,-4.9,-19).beginStroke().moveTo(6,-2.8).lineTo(6,-1.2).curveTo(6,2.8,2,2.8).lineTo(-6,2.8).lineTo(-6,1.8).lineTo(2.2,1.8).curveTo(5,1.8,5,-1.2).lineTo(5,-2.8).closePath();
	this.shape_97.setTransform(7,49.2);

	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],-4.9,29.1,-4.9,7.1).beginStroke().moveTo(6,23.2).lineTo(5,23.2).lineTo(5,-19.2).curveTo(5,-22.1,2.2,-22.2).lineTo(-6,-22.2).lineTo(-6,-23.2).lineTo(2,-23.2).curveTo(6,-23.2,6,-19.2).closePath();
	this.shape_98.setTransform(7,23.2);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.beginFill("rgba(255,0,0,0)").beginStroke().moveTo(1.5,-26).lineTo(1.5,26).lineTo(-1.5,26).lineTo(-1.5,-26).closePath();
...
(lib.ScrollBar_thumbIcon = function() {
	...
	this.shape_101.graphics.beginFill("#5A6165").beginStroke().moveTo(2.5,0.5).lineTo(-2.5,0.5).lineTo(-2.5,-0.5).lineTo(2.5,-0.5).closePath();
	this.shape_101.setTransform(2.5,0.5);

	this.shape_102 = new cjs.Shape();
	this.shape_102.graphics.beginFill("#5A6165").beginStroke().moveTo(2.5,0.5).lineTo(-2.5,0.5).lineTo(-2.5,-0.5).lineTo(2.5,-0.5).closePath();
...
(lib.ScrollArrowUp_disabledSkin = function() {
	...
	this.shape_105.graphics.beginLinearGradientFill(["rgba(91,93,94,0.298)","rgba(183,186,188,0.298)"],[0,1],1,5.9,1,-6.9).beginStroke().moveTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).lineTo(7.5,7).closePath().moveTo(-6.5,-6).lineTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).closePath();
...
(lib.ScrollArrowDown_disabledSkin = function() {
	...
	this.shape_108.graphics.beginLinearGradientFill(["rgba(91,93,94,0.298)","rgba(183,186,188,0.298)"],[0,1],1,5.9,1,-6.9).beginStroke().moveTo(-6.5,-6).lineTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).closePath().moveTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).lineTo(7.5,7).closePath();
...
(lib.CellRenderer_upSkin = function() {
	...
	this.shape_112.graphics.beginLinearGradientFill(["#5B5D5E","#B7BABC"],[0,1],67.5,-9.8,67.5,3).beginStroke().moveTo(-75,9.8).lineTo(-75,10).lineTo(75,10).lineTo(75,9.8).lineTo(76,9.8).lineTo(76,11).lineTo(-76,11).lineTo(-76,9.8).closePath().moveTo(-75,-10).lineTo(-76,-10).lineTo(-76,-11).lineTo(76,-11).lineTo(76,-10).lineTo(75,-10).closePath();
	this.shape_112.setTransform(76,11);

	this.shape_113 = new cjs.Shape();
	this.shape_113.graphics.beginFill("#B7BABC").beginStroke().moveTo(-76,-9.9).lineTo(-75,-9.9).lineTo(-75,9.9).lineTo(-76,9.9).closePath().moveTo(76,9.9).lineTo(75,9.9).lineTo(75,-9.9).lineTo(76,-9.9).closePath();
	this.shape_113.setTransform(76,10.9);

	// fill
	this.shape_114 = new cjs.Shape();
	this.shape_114.graphics.beginFill("#FFFFFF").beginStroke().moveTo(76,11).lineTo(-76,11).lineTo(-76,-11).lineTo(76,-11).closePath();
...
(lib.CellRenderer_selectedUpSkin = function() {
	...
	this.shape_116.graphics.beginFill("#B7BABC").beginStroke().moveTo(75,9.9).lineTo(75,-9.9).lineTo(76,-9.9).lineTo(76,9.9).closePath().moveTo(-76,-9.9).lineTo(-75,-9.9).lineTo(-75,9.9).lineTo(-76,9.9).closePath();
	this.shape_116.setTransform(76,11.1);
...
(lib.CellRenderer_selectedOverSkin = function() {
	...
	this.shape_118.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-12.4,6,-12.4,-5.5).beginStroke().moveTo(75,5.5).lineTo(-75,5.5).lineTo(-75,-5.5).lineTo(75,-5.5).closePath();
	this.shape_118.setTransform(76,6.5);

	// fill
	this.shape_119 = new cjs.Shape();
	this.shape_119.graphics.beginLinearGradientFill(["rgba(238,238,238,0.651)","rgba(255,255,255,0.749)"],[0,1],-12.4,11.6,-12.4,-11).beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath();
	this.shape_119.setTransform(76,11);

	this.shape_120 = new cjs.Shape();
	this.shape_120.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],-67.4,9.9,-67.4,-2.9).beginStroke().moveTo(76,-11).lineTo(76,11).lineTo(-76,11).lineTo(-76,-11).closePath().moveTo(75,10).lineTo(75,-10).lineTo(-75,-10).lineTo(-75,10).closePath();
	this.shape_120.setTransform(76,11);

	// border
	this.shape_121 = new cjs.Shape();
	this.shape_121.graphics.beginFill("#DAF1FF").beginStroke().moveTo(76,11).lineTo(-76,11).lineTo(-76,-11).lineTo(76,-11).closePath();
	this.shape_121.setTransform(76,11);

	this.addChild(this.shape_121,this.shape_120,this.shape_119,this.shape_118);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,152,22.1);
...
(lib.CellRenderer_selectedDownSkin = function() {
	...
	this.shape_122.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],-67.4,9.9,-67.4,-2.9).beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath().moveTo(76,-11).lineTo(-76,-11).lineTo(-76,11).lineTo(76,11).closePath();
	this.shape_122.setTransform(76,11);

	// fill
	this.shape_123 = new cjs.Shape();
	this.shape_123.graphics.beginFill("#9AD8FF").beginStroke().moveTo(76,11).lineTo(-76,11).lineTo(-76,-11).lineTo(76,-11).closePath();
	this.shape_123.setTransform(76,11);

	this.addChild(this.shape_123,this.shape_122);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,152,22.1);
...
(lib.CellRenderer_selectedDisabledSkin = function() {
	...
	this.shape_124.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.2)"],[0,1],-12.4,6,-12.4,-5.5).beginStroke().moveTo(75,5.5).lineTo(-75,5.5).lineTo(-75,-5.5).lineTo(75,-5.5).closePath();
	this.shape_124.setTransform(76,6.5);

	// fill
	this.shape_125 = new cjs.Shape();
	this.shape_125.graphics.beginLinearGradientFill(["rgba(204,204,204,0.2)","rgba(255,255,255,0.298)"],[0,1],-12.4,11.6,-12.4,-11).beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath();
	this.shape_125.setTransform(76,11);

	this.shape_126 = new cjs.Shape();
	this.shape_126.graphics.beginLinearGradientFill(["rgba(91,93,94,0.298)","rgba(183,186,188,0.298)"],[0,1],-67.4,9.9,-67.4,-2.9).beginStroke().moveTo(76,-11).lineTo(76,11).lineTo(-76,11).lineTo(-76,-11).closePath().moveTo(75,10).lineTo(75,-10).lineTo(-75,-10).lineTo(-75,10).closePath();
...
(lib.CellRenderer_overSkin = function() {
	...
	this.shape_127.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],67.5,-9.8,67.5,3).beginStroke().moveTo(76,-11).lineTo(-76,-11).lineTo(-76,11).lineTo(76,11).closePath().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath();
	this.shape_127.setTransform(76,11);

	// fill
	this.shape_128 = new cjs.Shape();
	this.shape_128.graphics.beginFill("#DAF1FF").beginStroke().moveTo(76,11).lineTo(-76,11).lineTo(-76,-11).lineTo(76,-11).closePath();
...
(lib.CellRenderer_downSkin = function() {
	...
	this.shape_129.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],67.5,-9.8,67.5,3).beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath().moveTo(76,-11).lineTo(-76,-11).lineTo(-76,11).lineTo(76,11).closePath();
	this.shape_129.setTransform(76,11);

	// fill
	this.shape_130 = new cjs.Shape();
	this.shape_130.graphics.beginFill("#9AD8FF").beginStroke().moveTo(76,11).lineTo(-76,11).lineTo(-76,-11).lineTo(76,-11).closePath();
...
(lib.CellRenderer_disabledSkin = function() {
	...
	this.shape_131.graphics.beginLinearGradientFill(["rgba(91,93,94,0.298)","rgba(183,186,188,0.298)"],[0,1],67.5,-9.8,67.5,3).beginStroke().moveTo(75,10).lineTo(-75,10).lineTo(-75,-10).lineTo(75,-10).closePath().moveTo(76,-11).lineTo(-76,-11).lineTo(-76,11).lineTo(76,11).closePath();
	this.shape_131.setTransform(76,11);

	// fill
	this.shape_132 = new cjs.Shape();
	this.shape_132.graphics.beginFill("rgba(255,255,255,0.298)").beginStroke().moveTo(76,11).lineTo(-76,11).lineTo(-76,-11).lineTo(76,-11).closePath();
...
(lib.Button_upSkin = function() {
	...
	this.shape_133.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.298)"],[0,1],40.6,5.5,40.6,-4.9).beginStroke().moveTo(20,5.5).lineTo(-20,5.5).lineTo(-20,-2.5).curveTo(-20,-5.5,-17,-5.5).lineTo(20,-5.5).closePath();
	this.shape_133.setTransform(21,6.5);

	this.shape_134 = new cjs.Shape();
	this.shape_134.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.298)"],[0,1],19.5,1.6,19.5,-4.8).beginStroke().moveTo(-20,5.5).lineTo(-20,-5.5).lineTo(17,-5.5).curveTo(20,-5.5,20,-2.5).lineTo(20,5.5).closePath();
	this.shape_134.setTransform(61,6.5);

	// fill
	this.shape_135 = new cjs.Shape();
	this.shape_135.graphics.beginLinearGradientFill(["rgba(204,204,204,0.4)","rgba(255,255,255,0.6)"],[0,1],-9.8,11,-9.8,-10.9).beginStroke().moveTo(20,10).lineTo(-17.1,10).curveTo(-20,9.9,-20,7).lineTo(-20,-7).curveTo(-20,-9.9,-17.1,-10).lineTo(20,-10).closePath();
	this.shape_135.setTransform(21,11);

	this.shape_136 = new cjs.Shape();
	this.shape_136.graphics.beginLinearGradientFill(["rgba(204,204,204,0.4)","rgba(255,255,255,0.6)"],[0,1],10,11,10,-10.9).beginStroke().moveTo(-20,10).lineTo(-20,-10).lineTo(17.1,-10).curveTo(20,-9.9,20,-7).lineTo(20,7).curveTo(20,9.9,17.1,10).closePath();
	this.shape_136.setTransform(61,11);
	...
	this.shape_138.setTransform(61.5,11);

	this.addChild(this.shape_138,this.shape_137,this.shape_136,this.shape_135,this.shape_134,this.shape_133);
}).prototype = p = new cjs.Container();
...
(lib.Button_selectedUpSkin = function() {
	...
	this.shape_139.graphics.beginLinearGradientFill(["rgba(204,204,204,0.4)","rgba(204,204,204,0.6)"],[0,1],19,11,19,-10.9).beginStroke().moveTo(-11,-10).lineTo(8.1,-10).curveTo(11,-9.9,11,-7).lineTo(11,7).curveTo(11,9.9,8.1,10).lineTo(-11,10).closePath();
...
(lib.Button_selectedOverSkin = function() {
	...
	this.shape_144.graphics.beginLinearGradientFill(["rgba(204,204,204,0.4)","rgba(204,204,204,0.6)"],[0,1],19,11,19,-10.9).beginStroke().moveTo(-11,10).lineTo(-11,-10).lineTo(8.1,-10).curveTo(11,-9.9,11,-7).lineTo(11,7).curveTo(11,9.9,8.1,10).closePath();
...
(lib.Button_selectedDownSkin = function() {
	...
	this.shape_147.graphics.beginLinearGradientFill(["#94D2FC","#ADE4FC","#BEEAFC"],[0,1,1],10,-10.9,10,11).beginStroke().moveTo(20,10).lineTo(-17.1,10).curveTo(-20,9.9,-20,7).lineTo(-20,-7).curveTo(-20,-9.9,-17.1,-10).lineTo(20,-10).closePath();
	this.shape_147.setTransform(21,11);

	this.shape_148 = new cjs.Shape();
	this.shape_148.graphics.beginLinearGradientFill(["#94D2FC","#ADE4FC","#BEEAFC"],[0,1,1],-18.8,-10.9,-18.8,11).beginStroke().moveTo(-11,-10).lineTo(8.1,-10).curveTo(11,-9.9,11,-7).lineTo(11,7).curveTo(11,9.9,8.1,10).lineTo(-11,10).closePath();
...
(lib.Button_selectedDisabledSkin = function() {
	...
	this.shape_151.graphics.beginLinearGradientFill(["rgba(204,204,204,0.2)","rgba(204,204,204,0.298)"],[0,1],-9.8,11,-9.8,-10.9).beginStroke().moveTo(20,10).lineTo(-17.1,10).curveTo(-20,9.9,-20,7).lineTo(-20,-7).curveTo(-20,-9.9,-17.1,-10).lineTo(20,-10).closePath();
	this.shape_151.setTransform(21,11);

	this.shape_152 = new cjs.Shape();
	this.shape_152.graphics.beginLinearGradientFill(["rgba(204,204,204,0.2)","rgba(204,204,204,0.298)"],[0,1],19,11,19,-10.9).beginStroke().moveTo(-11,10).lineTo(-11,-10).lineTo(8.1,-10).curveTo(11,-9.9,11,-7).lineTo(11,7).curveTo(11,9.9,8.1,10).closePath();
	this.shape_152.setTransform(52,11);
...
(lib.Button_overSkin = function() {
	...
	this.shape_155.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.298)"],[0,1],40.6,5.5,40.6,-4.9).beginStroke().moveTo(20,5.5).lineTo(-20,5.5).lineTo(-20,-2.5).curveTo(-20,-5.5,-17,-5.5).lineTo(20,-5.5).closePath();
	this.shape_155.setTransform(21,6.5);

	this.shape_156 = new cjs.Shape();
	this.shape_156.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.298)"],[0,1],19.5,1.5,19.5,-4.9).beginStroke().moveTo(-20,5.5).lineTo(-20,-5.5).lineTo(17,-5.5).curveTo(20,-5.5,20,-2.5).lineTo(20,5.5).closePath();
	this.shape_156.setTransform(61,6.5);

	// fill
	this.shape_157 = new cjs.Shape();
	this.shape_157.graphics.beginLinearGradientFill(["rgba(204,204,204,0.4)","rgba(255,255,255,0.6)"],[0,1],30,11,30,-10.9).beginStroke().moveTo(40,7).curveTo(40,9.9,37.1,10).lineTo(-37.1,10).curveTo(-40,9.9,-40,7).lineTo(-40,-7).curveTo(-40,-9.9,-37.1,-10).lineTo(37.1,-10).curveTo(40,-9.9,40,-7).closePath();
	...
	this.shape_159.setTransform(61.5,11);
...
(lib.Button_emphasizedSkin = function() {
	...
	this.shape_160.graphics.beginFill("rgba(255,255,255,0)").beginStroke().drawRoundRect(-40.05,-10,80.1,20,3);
	...
	this.shape_161.setTransform(41,11);

	this.addChild(this.shape_161,this.shape_160);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0.1,0,82,22);
...
(lib.Button_downSkin = function() {
	...
	this.shape_162.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.298)"],[0,1],40.6,5.5,40.6,-4.9).beginStroke().moveTo(20,5.5).lineTo(-20,5.5).lineTo(-20,-2.5).curveTo(-20,-5.5,-17,-5.5).lineTo(20,-5.5).closePath();
	this.shape_162.setTransform(21,6.5);

	this.shape_163 = new cjs.Shape();
	this.shape_163.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.298)"],[0,1],19.5,1.5,19.5,-4.9).beginStroke().moveTo(-20,5.5).lineTo(-20,-5.5).lineTo(17,-5.5).curveTo(20,-5.5,20,-2.5).lineTo(20,5.5).closePath();
	this.shape_163.setTransform(61,6.5);

	// fill
	this.shape_164 = new cjs.Shape();
	this.shape_164.graphics.beginLinearGradientFill(["#99D7FE","#D9F0FE"],[0,1],-9.8,11,-9.8,-10.9).beginStroke().moveTo(20,-10).lineTo(20,10).lineTo(-17.1,10).curveTo(-20,9.9,-20,7).lineTo(-20,-7).curveTo(-20,-9.9,-17.1,-10).closePath();
	this.shape_164.setTransform(21,11);

	this.shape_165 = new cjs.Shape();
	this.shape_165.graphics.beginLinearGradientFill(["#99D7FE","#D9F0FE"],[0,1],10,11,10,-10.9).beginStroke().moveTo(-20,10).lineTo(-20,-10).lineTo(17.1,-10).curveTo(20,-9.9,20,-7).lineTo(20,7).curveTo(20,9.9,17.1,10).closePath();
	this.shape_165.setTransform(61.1,11);
	...
	this.addChild(this.shape_167,this.shape_166,this.shape_165,this.shape_164,this.shape_163,this.shape_162);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,82,22);
...
(lib.Button_disabledSkin = function() {
	...
	this.shape_168.graphics.beginLinearGradientFill(["rgba(204,204,204,0)","rgba(255,255,255,0.149)"],[0,1],39.5,1.6,39.5,-4.8).beginStroke().moveTo(40,5.5).lineTo(-40,5.5).lineTo(-40,-2.5).curveTo(-40,-5.5,-37,-5.5).lineTo(37,-5.5).curveTo(40,-5.5,40,-2.5).closePath();
	this.shape_168.setTransform(41,6.5);

	// fill
	this.shape_169 = new cjs.Shape();
	this.shape_169.graphics.beginLinearGradientFill(["rgba(204,204,204,0.2)","rgba(255,255,255,0.298)"],[0,1],30,11,30,-10.9).beginStroke().moveTo(40,7).curveTo(40,9.9,37.1,10).lineTo(-37.1,10).curveTo(-40,9.9,-40,7).lineTo(-40,-7).curveTo(-40,-9.9,-37.1,-10).lineTo(37.1,-10).curveTo(40,-9.9,40,-7).closePath();
...
(lib.Component_avatar = function() {
	...
	this.shape_172.graphics.beginFill("#FFFFFF").beginStroke("#000000").setStrokeStyle(0.1,1,1).moveTo(40,11).lineTo(-40,11).lineTo(-40,-11).lineTo(40,-11).closePath();
	this.shape_172.setTransform(40,11);

	this.addChild(this.shape_172);
}).prototype = p = new cjs.Container();
...
(lib.Trilby = function() {
	...
	this.shape_175.setTransform(0,0.2);
...
(lib.leg_upper = function(mode,startPosition,loop) {
	...
	this.shape_189.graphics.beginFill("#000000").beginStroke().moveTo(1.5,5.4).curveTo(0.8,5.4,0.4,3.5).curveTo(-0.3,0.7,-0.3,0.5).curveTo(-1,-0.7,-1.5,-1.6).curveTo(-2.4,-3.3,-2.4,-4.2).curveTo(-2.4,-7,0,-2.7).curveTo(2.4,1.5,2.4,4).curveTo(2.4,5.4,1.5,5.4).closePath();
	this.shape_189.setTransform(2.4,5.3);

	this.shape_190 = new cjs.Shape();
	this.shape_190.graphics.beginFill("#000000").beginStroke().moveTo(-1.5,-1.8).curveTo(-2.4,-3.4,-2.4,-4.2).curveTo(-2.4,-5.2,-1.6,-5.1).curveTo(-0.8,-5.1,-0.5,-3.8).curveTo(-0.4,-3.4,0.2,-2.4).curveTo(0.8,-1.4,0.9,-1.1).curveTo(1,-0.8,1.7,1.5).curveTo(2.4,3.7,2.4,4.1).curveTo(2.4,5.1,1.6,5.1).curveTo(0.9,5.1,0.3,3.3).curveTo(-0.2,1.1,-0.4,0.5).curveTo(-0.4,0.3,-1.5,-1.8).closePath();
	this.shape_190.setTransform(2.4,5.5);

	this.shape_191 = new cjs.Shape();
	this.shape_191.graphics.beginFill("#000000").beginStroke().moveTo(-1.5,-1.6).curveTo(-2.3,-3.3,-2.3,-4.2).curveTo(-2.3,-5.1,-1.7,-5.1).curveTo(-1.1,-5.2,-0.7,-3.9).lineTo(0.7,-1.1).curveTo(0.7,-1.1,1.5,1.3).curveTo(2.3,3.8,2.3,4.2).curveTo(2.3,5.1,1.6,5.1).curveTo(0.7,5.1,0.2,3.2).curveTo(-0.3,1.1,-0.4,0.6).curveTo(-0.5,0.5,-1.5,-1.6).closePath();
	this.shape_191.setTransform(2.5,5.5);

	this.shape_192 = new cjs.Shape();
	this.shape_192.graphics.beginFill("#000000").beginStroke().moveTo(-2.4,-4.2).curveTo(-2.4,-5.2,-1.8,-5.1).curveTo(-1.2,-5,-0.6,-3.8).curveTo(0.7,-1.8,0.9,-1).curveTo(1.3,0.8,2.4,4.3).curveTo(2.4,4.5,2.2,4.8).curveTo(2,5.1,1.6,5.1).curveTo(0.5,5.1,-0.1,3.2).curveTo(-0.4,1,-0.5,0.5).curveTo(-0.6,0.2,-1.5,-1.8).curveTo(-2.4,-3.7,-2.4,-4.2).closePath();
	this.shape_192.setTransform(2.6,5.7);
...
(lib.leg_lower = function(mode,startPosition,loop) {
	...
	this.shape_193.graphics.beginFill("#000000").beginStroke().moveTo(-0.3,0.5).curveTo(-1.8,-4.1,-1.8,-5.3).curveTo(-1.8,-6.6,-0.9,-6.2).curveTo(-0.1,-5.8,0.1,-4.6).curveTo(0.2,-3.6,1.1,-1.6).curveTo(1.8,2.9,1.8,4.4).curveTo(1.8,4.5,1.8,5.5).curveTo(1.7,6.3,1,6.3).curveTo(0.3,6.3,0.1,3.9).curveTo(-0.2,1.2,-0.3,0.5).closePath();
	this.shape_193.setTransform(1.8,6.3);

	this.shape_194 = new cjs.Shape();
	this.shape_194.graphics.beginFill("#000000").beginStroke().moveTo(0.9,5.7).curveTo(-0.4,5.7,-0.4,0.7).curveTo(-0.4,0.1,-1.1,-1.9).curveTo(-1.8,-4,-1.8,-4.2).curveTo(-1.8,-5.2,-1.1,-5.6).curveTo(-0.5,-6,-0.2,-4.3).curveTo(0,-3.4,0.9,-1.3).curveTo(1.8,1.1,1.8,4.5).curveTo(1.8,5.7,0.9,5.7).closePath();
	this.shape_194.setTransform(2,6.8);

	this.shape_195 = new cjs.Shape();
	this.shape_195.graphics.beginFill("#000000").beginStroke().moveTo(-1.8,-4.6).curveTo(-1.8,-5.5,-1,-5.5).curveTo(-0.2,-5.5,-0.2,-4.6).lineTo(-0.2,-4.5).curveTo(-0,-4.2,0.1,-3.8).lineTo(1,-1.2).curveTo(1.8,3.6,1.8,4).lineTo(1.8,4.9).curveTo(1.7,5.5,1,5.5).curveTo(0.5,5.5,0,3.6).curveTo(-0.4,2,-0.4,0.8).curveTo(-0.4,-0.4,-1.6,-3.8).curveTo(-1.8,-4,-1.8,-4.6).closePath();
	this.shape_195.setTransform(2,6.7);

	this.shape_196 = new cjs.Shape();
	this.shape_196.graphics.beginFill("#000000").beginStroke().moveTo(0.9,5.2).curveTo(-0.1,5.2,-1.7,-4.3).curveTo(-1.7,-5.6,-0.8,-5).curveTo(0.1,-4.5,0.3,-3.7).curveTo(0.4,-3.4,0.6,-2.4).curveTo(0.9,-1.5,0.9,-1.1).curveTo(0.8,-0.4,1.2,1.4).curveTo(1.6,3.4,1.6,4.1).curveTo(1.6,5.2,0.9,5.2).closePath();
	this.shape_196.setTransform(2.1,6.8);
...
(lib.arm_upper = function(mode,startPosition,loop) {
	...
	this.shape_197.graphics.beginFill("#000000").beginStroke().moveTo(-1.1,-0.5).curveTo(-2.2,-3.4,-1.8,-3.7).curveTo(-1,-4,-0.2,-3.1).curveTo(0.3,-2.1,0.3,-2).curveTo(2,0.8,1.8,2.8).curveTo(1.6,4.9,0.3,2.7).curveTo(-0.2,1.8,-1.1,-0.5).closePath();
	this.shape_197.setTransform(1.9,3.8);

	this.shape_198 = new cjs.Shape();
	this.shape_198.graphics.beginFill("#000000").beginStroke().moveTo(1.2,3.9).curveTo(-0.1,3.9,-2,-2.7).curveTo(-2,-4.6,-1,-3.5).curveTo(-0.4,-2.7,0.5,-0.9).curveTo(0.6,-0.1,1.3,1.5).curveTo(1.7,2.3,2,3.1).curveTo(2,3.9,1.2,3.9).closePath();
	this.shape_198.setTransform(2,3.4);

	this.shape_199 = new cjs.Shape();
	this.shape_199.graphics.beginFill("#000000").beginStroke().moveTo(2,3.2).curveTo(1.8,3.4,1.5,3.4).curveTo(0.7,3.4,-2.3,-2.5).curveTo(-2.3,-3.1,-1.9,-3.4).curveTo(-1.4,-3.7,-0.8,-2.8).curveTo(-0.7,-2.5,-0.1,-1.9).curveTo(0.6,-1.2,0.7,-1).curveTo(0.7,-0.9,0.9,-0.2).curveTo(1.1,0.4,1.4,0.8).curveTo(1.5,1,2,1.7).curveTo(2.3,2.3,2.3,2.5).curveTo(2.3,2.9,2,3.2).closePath();
	this.shape_199.setTransform(1.7,3.4);

	this.shape_200 = new cjs.Shape();
	this.shape_200.graphics.beginFill("#000000").beginStroke().moveTo(1.6,4.2).curveTo(0.8,4.2,-2.4,-3).curveTo(-2.4,-5.1,-1.3,-3.6).curveTo(-0.7,-2.8,0.3,-1.1).curveTo(0.6,-0.4,1.6,1.1).curveTo(2.4,2.5,2.4,3.4).curveTo(2.4,4.2,1.6,4.2).closePath();
	this.shape_200.setTransform(1.9,3.3);
...
(lib.mcPlayer_static_torso = function(mode,startPosition,loop) {
	...
	this.shape_201.graphics.beginFill("#000000").beginStroke().moveTo(1,0.1).curveTo(1.2,8.3,0.7,10.9).curveTo(0.7,11.1,0.7,11.3).curveTo(0.7,11.3,0.7,11.4).curveTo(0.6,11.5,0.6,11.7).curveTo(0.6,11.7,0.6,11.8).curveTo(0.5,11.8,0.4,11.9).curveTo(0.4,11.9,0.3,12).curveTo(0.2,12,0.1,12.2).curveTo(0,12.2,0,12.2).lineTo(-0.2,12.2).curveTo(-0.4,11.9,-0.7,11.8).curveTo(-0.7,11.7,-0.8,11.5).curveTo(-0.8,9.6,-0.8,7).curveTo(-0.8,6.6,-0.8,6.2).curveTo(-0.9,4.2,-0.9,2.3).curveTo(-0.9,0.2,-1,-2).curveTo(-1.2,-4,-1.6,-7.2).curveTo(-2,-11.1,-0.5,-11.9).curveTo(-0.4,-12.1,-0,-12.2).curveTo(0.2,-12.2,0.4,-12).curveTo(1.9,-11.8,1.7,-7.6).curveTo(1,-1.9,1,0.1).closePath();
	this.shape_201.setTransform(-0.5,-1.4);

	this.shape_202 = new cjs.Shape();
	this.shape_202.graphics.beginFill("#000000").beginStroke().moveTo(0.7,-11.6).lineTo(0.7,2.4).curveTo(1,7.3,1,9.9).curveTo(1,10.3,1,10.6).curveTo(1.2,11.2,1.2,11.6).curveTo(1.2,12.5,0.6,12.7).lineTo(0.6,12.7).curveTo(0.3,12.8,0.1,12.8).curveTo(0,12.7,-0,12.7).curveTo(-0.1,12.5,-0.3,12.4).curveTo(-1,11.1,-1.1,6.1).curveTo(-1.2,2.8,-1.1,-0.6).curveTo(-1.1,-6.5,-1,-8.8).curveTo(-1,-10.5,-0.9,-11.8).curveTo(-0.8,-12.3,-0.8,-12.6).curveTo(-0.8,-12.6,-0.8,-12.6).curveTo(-0.7,-12.8,-0.6,-12.8).curveTo(-0.4,-12.8,-0.2,-12.8).curveTo(-0.1,-12.8,0,-12.8).curveTo(0.2,-12.8,0.3,-12.8).curveTo(0.4,-12.6,0.5,-12.5).lineTo(0.5,-12).curveTo(0.6,-11.8,0.7,-11.6).closePath();
	this.shape_202.setTransform(-0.4,-0.3);

	this.shape_203 = new cjs.Shape();
	this.shape_203.graphics.beginFill("#000000").beginStroke().moveTo(1,-6.1).curveTo(1,-5.8,1.2,-5.5).curveTo(1,-4.8,0.9,-3.9).curveTo(0.9,-3.9,0.9,-4).lineTo(0.8,7.8).curveTo(0.9,9,1.1,10.4).curveTo(1.1,11.2,0.7,11.7).curveTo(0.7,12,0.7,12.4).lineTo(0.7,12.7).curveTo(0.5,13,0.4,13.4).curveTo(0.1,13,-0.3,12.8).curveTo(-0.3,12.4,-0.4,12.1).lineTo(-0.6,12).curveTo(-1.2,0.8,-1.2,-1.9).curveTo(-1.2,-6.4,-1.2,-7.6).curveTo(-1.1,-9.6,-0.8,-11.1).curveTo(-0.8,-11.4,-0.8,-11.7).curveTo(-0.8,-12.4,-0.8,-12.9).curveTo(-0.5,-13.1,-0.3,-13.4).curveTo(-0.1,-13.1,0.2,-12.8).curveTo(0.3,-12.7,0.3,-12.5).curveTo(1.4,-11.4,1.2,-8.2).curveTo(1.1,-7.1,1,-6.1).closePath();
	this.shape_203.setTransform(-0.6,0);
...
(lib.mcPlayer_running_legs = function(mode,startPosition,loop) {
	...
	this.shape_251.setTransform(-9.7,17.3);
...
(lib.mcPlayer_running_arms = function(mode,startPosition,loop) {
	...
	this.shape_263.setTransform(3.5,-2.4);
...
(lib.mcPhysObj_hitbox = function() {
	...
	this.shape_281.graphics.beginFill("#000000").beginStroke().moveTo(15,-15).lineTo(15,15).lineTo(-15,15).lineTo(-15,-15).closePath();

	this.addChild(this.shape_281);
}).prototype = p = new cjs.Container();
...
(lib.mcCharacter_hitbox = function() {
	...
	this.shape_282.graphics.beginFill().beginStroke("#000000").setStrokeStyle(1,1,1).moveTo(12.5,-30).lineTo(12.5,30).lineTo(-12.5,30).lineTo(-12.5,-30).closePath();
	this.shape_282.setTransform(15,30);

	this.addChild(this.shape_282);
}).prototype = p = new cjs.Container();
...
(lib.weaponsMelee = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance_2 = new lib.Katana_1("synched",0);
	this.instance_2.setTransform(-0.5,-17.4,1,1,0,0,0,-0.6,-17.5);
...
(lib.ScrollArrowUp_downSkin = function() {
	...
	this.shape_312.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-1,3.5,-1,-3.1).beginStroke().moveTo(6.5,3.3).lineTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).closePath();
	this.shape_312.setTransform(7.6,4.3);

	this.shape_313 = new cjs.Shape();
	this.shape_313.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).lineTo(6.5,-6).closePath();
	...
	this.addChild(this.shape_314,this.shape_313,this.shape_312,this.instance_10);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowDown_downSkin = function() {
	...
	this.shape_315.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_315.setTransform(7.5,4.3);

	this.shape_316 = new cjs.Shape();
	this.shape_316.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(-6.5,-6).lineTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).closePath().moveTo(-7.5,7).lineTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).closePath();
	this.shape_316.setTransform(7.5,7);

	this.shape_317 = new cjs.Shape();
	this.shape_317.graphics.beginLinearGradientFill(["#99D7FE","#D9F0FE"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(-6.5,-6).lineTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).closePath();
	this.shape_317.setTransform(7.5,7);

	this.addChild(this.shape_317,this.shape_316,this.shape_315,this.instance_12);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.arm_lower = function(mode,startPosition,loop) {
	...
	this.shape_327.graphics.beginFill("#000000").beginStroke().moveTo(-1.3,-4).lineTo(-1.3,-4).curveTo(-1.3,-3.9,-1.3,-3.8).curveTo(-1.3,-3.8,-1.3,-3.7).lineTo(-1.3,-3.6).curveTo(-1.1,-3.4,-1.1,-3.1).curveTo(-1,-2.7,-1,-2).curveTo(-0.8,-0.7,-0.7,0.1).curveTo(-0.7,1,-0.7,1.1).curveTo(-0.6,1.3,-0.5,2.4).curveTo(-0.4,3.1,-0.2,3.7).lineTo(0.3,4.9).curveTo(0.8,5.3,1.2,3.9).curveTo(1.2,3.8,1.2,3.7).curveTo(1.2,3.1,1.3,2.7).curveTo(1.2,2.5,1.2,2.4).curveTo(1.2,2.3,1.2,2.2).curveTo(1.1,1,1,0.1).curveTo(1,-0,1,-0.1).lineTo(0.7,-2.4).curveTo(0.7,-2.5,0.7,-2.6).curveTo(0.7,-2.6,0.7,-2.7).curveTo(0.7,-2.9,0.6,-3.2).curveTo(0.6,-3.5,0.5,-3.7).curveTo(0.5,-4.7,-0.3,-4.9).curveTo(-0.8,-5.1,-1,-4.7).curveTo(-1.3,-4.8,-1.3,-4).closePath();
	this.shape_327.setTransform(1.8,4.8);

	this.shape_328 = new cjs.Shape();
	this.shape_328.graphics.beginFill("#000000").beginStroke().moveTo(1.5,3.8).curveTo(1.5,4,1.3,4.3).curveTo(0.9,4.7,0.5,4.7).curveTo(-0.8,4.7,-0.8,3.1).curveTo(-0.7,1.3,-0.9,0.9).curveTo(-1.1,0.5,-1.3,-1.2).curveTo(-1.5,-2.6,-1.5,-3).curveTo(-1.5,-5,-0.4,-4.6).curveTo(0.8,-4.2,0.6,-1.5).curveTo(0.6,-1.3,1,1).curveTo(1.5,3.3,1.5,3.8).closePath();
	this.shape_328.setTransform(1.9,4.5);

	this.shape_329 = new cjs.Shape();
	this.shape_329.graphics.beginFill("#000000").beginStroke().moveTo(-1.1,0.8).curveTo(-1.3,-1.2,-1.3,-3.1).curveTo(-1.3,-3.9,-0.6,-4.5).curveTo(0.1,-5.1,0.3,-3.7).curveTo(0.3,-3,0.5,-1.3).curveTo(0.7,0.1,1,1.6).curveTo(1.3,2.9,1.3,3.6).curveTo(1.3,4.7,0.5,4.7).curveTo(-0.6,4.7,-1.1,0.8).closePath();
	this.shape_329.setTransform(1.7,4.4);

	this.shape_330 = new cjs.Shape();
	this.shape_330.graphics.beginFill("#000000").beginStroke().moveTo(-0.2,3).curveTo(-0.1,1.9,-0.2,1.6).curveTo(-0.3,1.1,-0.9,-1.1).curveTo(-1.4,-2.8,-1.4,-4).curveTo(-1.4,-4.7,-0.4,-4.7).curveTo(0.5,-4.7,0.7,-3.3).curveTo(0.7,-1.6,0.8,-1.2).curveTo(1.4,1.1,1.4,2.3).curveTo(1.4,3.3,1.2,4).curveTo(0.8,5.2,0.1,4.4).curveTo(-0.3,3.9,-0.2,3).closePath();
	this.shape_330.setTransform(1.7,4.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_327}]}).to({state:[{t:this.shape_328}]},5).to({state:[{t:this.shape_329}]},5).to({state:[{t:this.shape_330}]},5).wait(5));
...
p.nominalBounds = new cjs.Rectangle(-5.9,-2.5,22.4,56.7);
...
(lib.mcPlayer_static_head = function(mode,startPosition,loop) {
	...
	this.shape_331.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0,-7.3).curveTo(5.5,-6.1,6.8,-4.4).curveTo(7.3,-3.9,7.3,-1.2).curveTo(7.3,-0.4,7.2,0.2).curveTo(6.8,1.4,6.1,2.8).curveTo(5.8,3.4,5.5,3.9).curveTo(4.8,5,4,5.8).curveTo(3.4,6.5,2.7,7).curveTo(2.5,7.2,2.3,7.3).lineTo(0,7.3).curveTo(-0.5,7.2,-1,7).curveTo(-4.4,6,-5.9,4.6).curveTo(-7.3,3.3,-7.3,1.4).curveTo(-7.3,0.8,-6.3,-3.4).curveTo(-6.2,-3.5,-6.1,-3.7).curveTo(-5.9,-4.1,-5.6,-4.4).curveTo(-5.1,-4.8,-4.1,-5.3).curveTo(-1.5,-6.7,-0.6,-7.3).curveTo(-0.3,-7.3,0,-7.3).closePath();
	this.shape_331.setTransform(0,-22);
...
(lib.mcPlayer_running_head = function(mode,startPosition,loop) {
	...
	this.shape_339.setTransform(8.2,-21.8);

	this.shape_340 = new cjs.Shape();
	this.shape_340.graphics.beginFill("#000000").beginStroke().moveTo(-6.4,-3.5).curveTo(-7.4,0.7,-7.4,1.5).curveTo(-7.4,1.9,-7.2,2.3).curveTo(-7,2.5,-7,2.7).curveTo(-6.9,2.7,-6.9,2.7).curveTo(-5.6,5.5,-3.6,6.6).curveTo(-3.2,6.4,-3,6.9).curveTo(-2,7.3,-0.8,7.3).lineTo(4.7,7.3).curveTo(6.7,4.8,7,3.5).curveTo(7.2,3,7.2,0.2).curveTo(7.2,-2.6,6.7,-3.9).curveTo(5.6,-6.9,2,-6.9).curveTo(0.2,-6.9,-1.4,-7).curveTo(-1.9,-6.8,-2.4,-6.6).curveTo(-6,-4.8,-6.4,-3.5).closePath().moveTo(-0.5,-9.2).curveTo(-0.2,-9.2,0.1,-9.1).curveTo(0.1,-9.2,0.1,-9.3).curveTo(0.5,-9.3,0.8,-9.3).curveTo(0.8,-9.2,0.8,-9.2).lineTo(0.8,-9.3).curveTo(6.8,-8.7,8.6,-4.9).curveTo(9.2,-3.6,9.2,-1.8).curveTo(9.1,-0.1,9.1,0).curveTo(9.4,2.6,8.7,4.8).curveTo(7.3,9.3,2,9.3).curveTo(-0.9,9.3,-3.1,8.5).curveTo(-3.6,7.9,-4.6,7.8).lineTo(-4.6,7.8).curveTo(-6.7,6.6,-8.1,4.5).curveTo(-9.2,4.2,-9.2,1.5).curveTo(-9.2,-6.1,-4.1,-8.5).curveTo(-2.3,-9.3,-0.5,-9.2).closePath();
	this.shape_340.setTransform(8.3,-22);

	this.shape_341 = new cjs.Shape();
	this.shape_341.graphics.beginFill("#FFFFFF").beginStroke().moveTo(5.8,-4.1).curveTo(6.9,-3.2,6.9,-1.1).curveTo(7.1,0.7,6.1,2.5).curveTo(4.1,6.1,-2.4,6.1).curveTo(-3.7,6.1,-5.4,4.4).curveTo(-7,2.8,-7,2).curveTo(-7,1.2,-5.3,-1.9).curveTo(-3.5,-5.2,-2.1,-6.1).curveTo(3.9,-5.6,5.8,-4.1).closePath();
	this.shape_341.setTransform(7.4,-19.8);

	this.shape_342 = new cjs.Shape();
	this.shape_342.graphics.beginFill("#000000").beginStroke().moveTo(1,-8).curveTo(5.5,-7.6,7.5,-4.9).curveTo(8.8,-3.2,8.8,-1.2).curveTo(8.8,1.6,7.6,3.9).curveTo(5.5,8.2,0.1,8.2).curveTo(-1.4,8.2,-2.7,7.9).curveTo(-2.7,8,-2.7,8).curveTo(-2.7,8.1,-2.8,8.1).curveTo(-3.3,7.7,-4.1,7.7).curveTo(-4.1,7.6,-4.1,7.6).curveTo(-6.4,6.9,-7.7,5.2).curveTo(-8.8,3.7,-8.8,2).curveTo(-8.8,0.4,-8.5,-0.3).curveTo(-7.7,-2.2,-7.4,-3.3).curveTo(-7,-4.7,-5.9,-5.9).curveTo(-5.8,-6,-5,-6.6).curveTo(-4.3,-7.1,-4.1,-7.2).curveTo(-3.1,-7.9,-3,-7.9).curveTo(-0.2,-8.3,0.6,-8.1).curveTo(0.2,-8,-0.1,-8).curveTo(0.5,-8,1,-8).curveTo(1,-7.9,1,-7.8).curveTo(1,-7.9,1,-8).closePath().moveTo(5.8,-4).curveTo(3.9,-5.5,-2.1,-6.1).curveTo(-3.5,-5.2,-5.3,-1.8).curveTo(-7,1.2,-7,2).curveTo(-7,2.8,-5.4,4.4).curveTo(-3.7,6.2,-2.4,6.2).curveTo(4.1,6.2,6.1,2.6).curveTo(7.1,0.8,6.9,-1.1).curveTo(6.9,-3.1,5.8,-4).closePath();
	this.shape_342.setTransform(7.4,-19.8);

	this.shape_343 = new cjs.Shape();
	this.shape_343.graphics.beginFill("#FFFFFF").beginStroke().moveTo(7.9,-0).curveTo(7.9,6.3,0.5,6.3).curveTo(-4.4,6.3,-6.6,3.9).curveTo(-7.9,2.3,-7.9,0.8).curveTo(-7.9,-1.2,-7.1,-3.3).curveTo(-5.8,-6.7,-3.2,-6.3).curveTo(3.7,-6.5,6.4,-3.9).curveTo(7.9,-2.4,7.9,-0).closePath();
	this.shape_343.setTransform(10.8,-20);

	this.shape_344 = new cjs.Shape();
	this.shape_344.graphics.beginFill("#000000").beginStroke().moveTo(6.4,-6.9).curveTo(9.8,-4.1,9.8,0.3).curveTo(9.8,2.9,8.6,4.9).curveTo(6.4,8.5,0.7,8.5).curveTo(-1.9,8.5,-3.8,8).curveTo(-3.8,8.1,-3.9,8.2).curveTo(-4.4,7.6,-5.4,7.4).curveTo(-7.4,6.5,-8.5,5).curveTo(-9.8,3.2,-9.8,1.1).curveTo(-9.8,-3.4,-7.6,-5.9).curveTo(-3.6,-10.5,6.4,-6.9).closePath().moveTo(7.9,0.2).curveTo(7.9,-2.2,6.4,-3.7).curveTo(3.7,-6.3,-3.2,-6.1).curveTo(-5.8,-6.5,-7.1,-3.1).curveTo(-7.9,-1,-7.9,1).curveTo(-7.9,2.5,-6.6,4.1).curveTo(-4.4,6.5,0.5,6.5).curveTo(7.9,6.5,7.9,0.2).closePath();
	this.shape_344.setTransform(10.8,-20.2);

	this.shape_345 = new cjs.Shape();
	this.shape_345.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,5.8).curveTo(-8.4,3.4,-8.4,0.4).curveTo(-8.4,-0.2,-8.2,-1.3).curveTo(-7.8,-3.1,-7,-4.5).curveTo(-4.6,-8.8,0.6,-7.5).curveTo(1.7,-6.4,5.6,-4.3).curveTo(8.4,-2.8,8.4,-1.6).curveTo(8.3,0.8,7.3,3.1).curveTo(5.3,7.8,1.1,7.8).curveTo(-1.1,7.8,-4.4,5.8).closePath();
	this.shape_345.setTransform(12.3,-19.4);

	this.shape_346 = new cjs.Shape();
	this.shape_346.graphics.beginFill("#000000").beginStroke().moveTo(0,-9.4).curveTo(4,-9,7.1,-6.9).curveTo(10.3,-4.6,10.3,-1.9).curveTo(10,1.2,8.7,3.9).curveTo(6.1,9.4,1.3,9.4).curveTo(-1.6,9.4,-4.2,7.9).curveTo(-4.2,8,-4.3,8.1).curveTo(-4.4,7.8,-4.6,7.6).curveTo(-5.2,7,-5.8,6.8).curveTo(-7,5.9,-8,4.9).curveTo(-10.3,3.4,-10.3,0.2).curveTo(-10.3,-5.1,-7.1,-7.6).curveTo(-4.3,-9.8,0,-9.4).closePath().moveTo(-4.4,5.5).curveTo(-1.1,7.4,1.1,7.4).curveTo(5.3,7.4,7.3,2.8).curveTo(8.3,0.4,8.4,-2).curveTo(8.4,-3.1,5.6,-4.7).curveTo(1.7,-6.8,0.6,-7.8).curveTo(-4.6,-9.1,-7,-4.8).curveTo(-7.8,-3.5,-8.2,-1.7).curveTo(-8.4,-0.5,-8.4,0).curveTo(-8.4,3.1,-4.4,5.5).closePath();
	this.shape_346.setTransform(12.3,-19.1);

	this.shape_347 = new cjs.Shape();
	this.shape_347.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,-3.3).curveTo(-5.5,-6.8,-2.8,-7.6).curveTo(2.1,-7.6,5.1,-3.6).curveTo(7.4,-0.6,7.4,2).curveTo(7.4,4.1,7.1,4.7).curveTo(6.2,6.3,2.7,7.6).lineTo(-0.9,7.6).curveTo(-5.8,6.6,-7,4.7).curveTo(-7.4,4.1,-7.4,1.8).curveTo(-7.4,-1,-6.7,-3.3).closePath();
	this.shape_347.setTransform(11.8,-22.3);

	this.shape_348 = new cjs.Shape();
	this.shape_348.graphics.beginFill("#000000").beginStroke().moveTo(0,-9.4).curveTo(3.7,-8.8,6.4,-5.7).curveTo(9.3,-2.4,9.3,1.9).curveTo(9.3,5,8.7,6.2).curveTo(7,9.5,0.9,9.5).curveTo(-2.1,9.5,-4.3,8.8).curveTo(-4.8,8.4,-5.7,8.3).lineTo(-5.7,8.2).curveTo(-7.4,7.3,-8.4,5.8).curveTo(-9.6,3.9,-9.3,1.7).curveTo(-9.3,-4.5,-6.4,-7.5).curveTo(-3.9,-10,0,-9.4).closePath().moveTo(-6.7,-3.4).curveTo(-7.4,-1.2,-7.4,1.7).curveTo(-7.4,3.9,-7,4.6).curveTo(-5.8,6.5,-0.9,7.5).lineTo(2.7,7.5).curveTo(6.2,6.1,7.1,4.6).curveTo(7.4,3.9,7.4,1.8).curveTo(7.4,-0.7,5.1,-3.8).curveTo(2.1,-7.8,-2.8,-7.8).curveTo(-5.5,-7,-6.7,-3.4).closePath();
	this.shape_348.setTransform(11.8,-22.1);

	this.shape_349 = new cjs.Shape();
	this.shape_349.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.9,-5.2).curveTo(-2.9,-6.7,0,-6.4).curveTo(2.9,-6.1,4.9,-4.2).curveTo(7.2,-2,7.2,1.3).curveTo(7.2,4.2,6.3,5.2).curveTo(5.1,6.5,1.7,6.5).curveTo(-3.7,6.5,-5.9,3.5).curveTo(-7.2,1.7,-7.2,-0.5).curveTo(-7.2,-3.6,-4.9,-5.2).closePath();
	this.shape_349.setTransform(12.8,-20.1);

	this.shape_350 = new cjs.Shape();
	this.shape_350.graphics.beginFill("#000000").beginStroke().moveTo(2.7,-7.8).curveTo(9.1,-7.2,9.1,1.1).curveTo(9.1,3.8,8.3,5.2).curveTo(6.7,8.3,1.8,8.3).curveTo(-1.4,8.3,-3.7,7.4).lineTo(-3.7,7.4).curveTo(-4.1,7,-4.8,6.9).curveTo(-6.7,5.9,-7.8,4.1).curveTo(-9.1,1.9,-9.1,-0.4).curveTo(-9.1,-3.7,-7.4,-5.7).curveTo(-4.5,-9.4,2.7,-7.8).closePath().moveTo(-4.9,-5.4).curveTo(-7.2,-3.8,-7.2,-0.7).curveTo(-7.2,1.6,-5.9,3.3).curveTo(-3.7,6.3,1.7,6.3).curveTo(5.1,6.3,6.3,5.1).curveTo(7.2,4,7.2,1.2).curveTo(7.2,-2.2,4.9,-4.3).curveTo(2.9,-6.3,0,-6.6).curveTo(-2.9,-6.9,-4.9,-5.4).closePath();
	this.shape_350.setTransform(12.8,-20);

	this.shape_351 = new cjs.Shape();
	this.shape_351.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0,-6.5).curveTo(2.8,-6,5,-4.3).curveTo(7.3,-2.6,7.3,-0.8).curveTo(7.3,0.7,6.4,3.1).curveTo(5.3,5.9,3.8,6.6).lineTo(-1,6.6).curveTo(-4.9,5.5,-6.3,3.3).curveTo(-7.3,2,-7.3,-0.2).curveTo(-7.3,-7.7,0,-6.5).closePath();
	this.shape_351.setTransform(10.5,-22);

	this.shape_352 = new cjs.Shape();
	this.shape_352.graphics.beginFill("#000000").beginStroke().moveTo(0,-6.5).curveTo(-7.3,-7.7,-7.3,-0.2).curveTo(-7.3,2,-6.3,3.3).curveTo(-4.9,5.5,-1,6.6).lineTo(3.8,6.6).curveTo(5.3,5.9,6.4,3.1).curveTo(7.3,0.7,7.3,-0.8).curveTo(7.3,-2.6,5,-4.3).curveTo(2.8,-6,0,-6.5).closePath().moveTo(0,-8.6).curveTo(3.7,-8.3,6.4,-6.2).curveTo(9.2,-3.9,9.2,-0.8).curveTo(9.2,2,8.3,4.1).curveTo(6.4,8.6,1.4,8.6).curveTo(-0.5,8.6,-2.1,8.3).curveTo(-2.1,8.3,-2.1,8.3).curveTo(-2.4,8.3,-2.6,8.2).curveTo(-3.1,8,-3.9,7.9).curveTo(-3.8,7.8,-3.7,7.7).curveTo(-6.1,6.7,-7.6,4.5).curveTo(-9.2,2.2,-9.2,-0).curveTo(-9.2,-4.7,-6.3,-7).curveTo(-3.8,-8.9,0,-8.6).closePath();
	this.shape_352.setTransform(10.5,-22);

	this.shape_353 = new cjs.Shape();
	this.shape_353.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.8,4.9).curveTo(-7.9,3.2,-7.9,1.6).curveTo(-7.9,-1.3,-7.2,-3).curveTo(-6,-5.5,-2.7,-7.4).curveTo(5.8,-4.7,7.1,-3.8).curveTo(7.9,-3.2,7.9,-0.3).curveTo(7.9,4.3,5.2,6).curveTo(3,7.4,-2.1,7.4).curveTo(-5.2,7.4,-6.8,4.9).closePath();
	this.shape_353.setTransform(13.3,-19);

	this.shape_354 = new cjs.Shape();
	this.shape_354.graphics.beginFill("#000000").beginStroke().moveTo(10.5,-20.7).curveTo(10.9,-20.5,12.2,-20.5).curveTo(14.2,-20.5,14.7,-17.8).curveTo(14.8,-17,14.8,-14.4).curveTo(14.9,-11.7,13.8,-9.3).curveTo(11.7,-4.6,5.8,-4.6).curveTo(2.8,-4.6,0.7,-5.3).curveTo(0.6,-5.2,0.6,-5.1).curveTo(0.3,-5.3,-0.1,-5.3).curveTo(-0.5,-5.9,-1.3,-6.1).curveTo(-4.8,-8,-4.8,-12.6).curveTo(-4.8,-14,-4,-16.5).curveTo(-3,-19.6,-1.6,-20.6).curveTo(-0.4,-21.5,2,-23.6).curveTo(4.2,-25,6.6,-22.9).curveTo(6.9,-22.7,10.5,-20.7).closePath().moveTo(-1.8,-9.1).curveTo(-0.2,-6.6,2.9,-6.6).curveTo(8,-6.6,10.2,-8).curveTo(12.9,-9.7,12.9,-14.3).curveTo(12.9,-17.2,12.1,-17.8).curveTo(10.8,-18.7,2.3,-21.4).curveTo(-1,-19.5,-2.2,-17).curveTo(-2.9,-15.3,-2.9,-12.4).curveTo(-2.9,-10.8,-1.8,-9.1).closePath().moveTo(-14.8,24.2).curveTo(-14.7,24,-14.6,23.9).curveTo(-14.6,23.9,-14.6,24).curveTo(-14.7,24.1,-14.8,24.2).closePath();
	this.shape_354.setTransform(8.3,-5);

	this.shape_355 = new cjs.Shape();
	this.shape_355.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,-6).curveTo(-3.4,-7.7,0,-7.1).curveTo(3.3,-6.6,5.7,-4.5).curveTo(8.3,-2.2,8.3,0.5).curveTo(8.3,3.3,7.3,4.6).curveTo(4.9,7.5,-2.2,7.3).curveTo(-8.3,2.6,-8.3,0.5).curveTo(-8.3,-4,-5.7,-6).closePath();
	this.shape_355.setTransform(13.2,-19.2);

	this.shape_356 = new cjs.Shape();
	this.shape_356.graphics.beginFill("#000000").beginStroke().moveTo(2,-10.2).curveTo(6.1,-9.6,9,-7).curveTo(12.2,-4.2,12.2,-0.5).curveTo(12.2,2.6,11.4,4.1).curveTo(9.9,6.6,5.3,8.3).lineTo(-0.7,8.3).curveTo(-1.6,7.7,-2.4,7.1).lineTo(-2.4,7.1).curveTo(-2.7,7,-3.1,6.9).curveTo(-3.6,6.2,-4.2,5.9).curveTo(-4.2,5.8,-4.1,5.8).curveTo(-8.2,2.4,-8.2,-0.6).curveTo(-8.2,-6,-5,-8.5).curveTo(-2.2,-10.7,2,-10.2).closePath().moveTo(-3.7,-7).curveTo(-6.3,-5,-6.3,-0.5).curveTo(-6.3,1.6,-0.2,6.3).curveTo(6.9,6.5,9.3,3.6).curveTo(10.3,2.3,10.3,-0.5).curveTo(10.3,-3.2,7.7,-5.5).curveTo(5.3,-7.6,2,-8.1).curveTo(-1.4,-8.7,-3.7,-7).closePath().moveTo(-12.2,10.3).lineTo(-12.2,10.3).lineTo(-12.2,10.3).closePath();
	this.shape_356.setTransform(11.2,-18.2);

	this.shape_357 = new cjs.Shape();
	this.shape_357.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.8,0.8).curveTo(-7.8,-1.1,-7.2,-3.6).curveTo(-6.5,-6.4,-5.4,-7.3).curveTo(7.8,-7.1,7.8,-2.1).curveTo(7.8,0.4,6.7,2.4).curveTo(5.7,4.1,2.6,7.3).lineTo(-2,7.3).curveTo(-2.4,7.1,-4.4,7).curveTo(-7.8,5.5,-7.8,0.8).closePath();
	this.shape_357.setTransform(13.2,-18.7);

	this.shape_358 = new cjs.Shape();
	this.shape_358.graphics.beginFill("#000000").beginStroke().moveTo(2.9,-8.6).curveTo(9.8,-6.3,9.8,-1.7).curveTo(9.8,1.1,8.3,4.3).curveTo(5.8,9.6,0.4,9.6).curveTo(-2.3,9.6,-4.3,9.1).curveTo(-4.3,9.1,-4.3,9.2).curveTo(-4.6,8.9,-5.1,8.9).curveTo(-5.5,8.6,-6,8.4).curveTo(-8.1,7.4,-9,5.5).curveTo(-10.1,3.5,-9.6,1.2).curveTo(-9.6,-0.7,-8.9,-3.6).curveTo(-8.1,-7.1,-7.1,-8).curveTo(-3.8,-10.9,2.9,-8.6).closePath().moveTo(-7.7,1.1).curveTo(-7.7,5.8,-4.4,7.3).curveTo(-2.4,7.4,-2,7.6).lineTo(2.6,7.6).curveTo(5.7,4.4,6.7,2.7).curveTo(7.9,0.8,7.9,-1.7).curveTo(7.9,-6.8,-5.4,-6.9).curveTo(-6.4,-6.1,-7.1,-3.2).curveTo(-7.7,-0.8,-7.7,1.1).closePath();
	this.shape_358.setTransform(13.1,-19);

	this.shape_359 = new cjs.Shape();
	this.shape_359.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0.3,-7.9).lineTo(2.5,-7.9).curveTo(4,-6.5,6.8,-5).curveTo(8.1,-4.4,8.1,-2.6).curveTo(8.1,-0.4,5.9,2.9).curveTo(3.7,6.4,1.1,7.9).lineTo(-2.7,7.9).curveTo(-4.1,7.9,-6,5.9).curveTo(-8,3.7,-8,1.6).curveTo(-8,-1.7,-6.8,-3.5).curveTo(-4.9,-6.3,0.3,-7.9).closePath();
	this.shape_359.setTransform(13,-19.5);

	this.shape_360 = new cjs.Shape();
	this.shape_360.graphics.beginFill("#000000").beginStroke().moveTo(0,-9.6).curveTo(4,-9.9,6.9,-8.1).curveTo(10,-6.1,10,-2.7).curveTo(9.7,0.6,8.2,3.7).curveTo(5.2,9.7,-0.7,9.7).curveTo(-2.6,9.7,-4.2,9.2).curveTo(-4.8,8.9,-5.7,8.9).curveTo(-5.8,8.8,-6,8.8).curveTo(-6.2,8.6,-6.5,8.4).curveTo(-6.5,8.4,-6.4,8.3).curveTo(-8.1,7.4,-9,5.7).curveTo(-10.1,3.7,-9.9,1.5).curveTo(-9.9,-3.6,-6.8,-6.6).curveTo(-4.1,-9.2,0,-9.6).closePath().moveTo(0.3,-8.1).curveTo(-4.9,-6.5,-6.8,-3.7).curveTo(-8,-1.9,-8,1.4).curveTo(-8,3.5,-6,5.7).curveTo(-4.1,7.7,-2.7,7.7).lineTo(1.1,7.7).curveTo(3.7,6.2,6,2.7).curveTo(8.1,-0.6,8.1,-2.8).curveTo(8.1,-4.6,6.8,-5.2).curveTo(4,-6.7,2.5,-8.1).closePath();
	this.shape_360.setTransform(12.9,-19.3);

	this.shape_361 = new cjs.Shape();
	this.shape_361.graphics.beginFill("#FFFFFF").beginStroke().moveTo(7.5,3.1).curveTo(6.2,4.9,2.7,7.1).lineTo(-3.6,7.1).curveTo(-6,4.8,-7.9,3.2).curveTo(-8.7,2.4,-8.7,0.2).curveTo(-8.7,-2.9,-7.5,-4.3).curveTo(-5.1,-7.3,2.4,-7.1).curveTo(5.8,-6.1,7.4,-4.1).curveTo(8.7,-2.6,8.7,-0.8).curveTo(8.7,1.4,7.5,3.1).closePath();
	this.shape_361.setTransform(12.6,-19.5);

	this.shape_362 = new cjs.Shape();
	this.shape_362.graphics.beginFill("#000000").beginStroke().moveTo(0,-15.7).curveTo(4.2,-15.2,7.3,-12.8).curveTo(10.6,-10.2,10.6,-7).curveTo(10.6,-4,9.3,-2.1).curveTo(7.6,0.4,3.2,2.8).lineTo(-3.4,2.8).curveTo(-3.9,2.5,-4.4,2.3).curveTo(-4.8,1.8,-5.3,1.6).curveTo(-8,-0.8,-10,-2.3).curveTo(-10.6,-3,-10.6,-6.1).curveTo(-10.6,-11.5,-7.3,-14).curveTo(-4.4,-16.2,0,-15.7).closePath().moveTo(7.5,-3.2).curveTo(8.7,-4.8,8.7,-7).curveTo(8.7,-8.9,7.4,-10.4).curveTo(5.8,-12.3,2.4,-13.3).curveTo(-5.1,-13.5,-7.5,-10.5).curveTo(-8.7,-9.1,-8.7,-6).curveTo(-8.7,-3.8,-7.9,-3).curveTo(-6,-1.5,-3.6,0.8).lineTo(2.7,0.8).curveTo(6.2,-1.4,7.5,-3.2).closePath().moveTo(-5.3,15.7).curveTo(-5.2,15.7,-5.2,15.7).curveTo(-5.2,15.7,-5.2,15.7).closePath();
	this.shape_362.setTransform(12.6,-13.2);

	this.shape_363 = new cjs.Shape();
	this.shape_363.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-0.5,-7.7).curveTo(2.5,-7.5,4.9,-5.9).curveTo(7.4,-4.2,7.6,-2.5).curveTo(7.9,0.6,7,3.3).curveTo(5,8.5,-1.5,7.7).curveTo(-3.7,5.7,-6.2,3.6).curveTo(-7.5,2.2,-7.6,-0.3).curveTo(-8.2,-8.5,-0.5,-7.7).closePath();
	this.shape_363.setTransform(10,-20.9);

	this.shape_364 = new cjs.Shape();
	this.shape_364.graphics.beginFill("#000000").beginStroke().moveTo(-0.4,-7.5).curveTo(-8.2,-8.2,-7.6,-0).curveTo(-7.4,2.4,-6.1,3.8).curveTo(-3.7,5.9,-1.5,8).curveTo(5.1,8.7,7,3.5).curveTo(8,0.9,7.6,-2.3).curveTo(7.5,-4,5,-5.6).curveTo(2.5,-7.2,-0.4,-7.5).closePath().moveTo(-0.6,-9.8).curveTo(3.2,-9.8,6.1,-7.8).curveTo(9.3,-5.6,9.5,-2.4).curveTo(9.8,1,8.9,3.8).curveTo(7.1,9.4,1.2,9.8).curveTo(-0.6,9.9,-2.2,9.4).lineTo(-2.2,9.5).curveTo(-2.4,9.4,-2.6,9.3).curveTo(-3.1,9,-3.8,8.7).curveTo(-3.8,8.7,-3.8,8.7).curveTo(-5.2,7.9,-6.4,6.4).curveTo(-9.3,3.3,-9.5,-0.1).curveTo(-9.9,-5,-7,-7.6).curveTo(-4.6,-9.8,-0.6,-9.8).closePath();
	this.shape_364.setTransform(10,-21.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_340},{t:this.shape_339}]}).to({state:[{t:this.shape_342},{t:this.shape_341}]},2).to({state:[{t:this.shape_344},{t:this.shape_343}]},2).to({state:[{t:this.shape_346},{t:this.shape_345}]},2).to({state:[{t:this.shape_348},{t:this.shape_347}]},2).to({state:[{t:this.shape_350},{t:this.shape_349}]},2).to({state:[{t:this.shape_352},{t:this.shape_351}]},2).to({state:[{t:this.shape_354},{t:this.shape_353}]},2).to({state:[{t:this.shape_356},{t:this.shape_355}]},2).to({state:[{t:this.shape_358},{t:this.shape_357}]},2).to({state:[{t:this.shape_360},{t:this.shape_359}]},2).to({state:[{t:this.shape_362},{t:this.shape_361}]},2).to({state:[{t:this.shape_364},{t:this.shape_363}]},2).wait(2));
...
p.nominalBounds = new cjs.Rectangle(-4.5,0,36.3,60.5);
...
(lib.ScrollArrowUp_upSkin = function() {
	...
	this.shape_400.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_400.setTransform(7.5,4.3);

	this.shape_401 = new cjs.Shape();
	this.shape_401.graphics.beginLinearGradientFill(["#5B5D5E","#B7BABC"],[0,1],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_401.setTransform(7.5,7);

	this.shape_402 = new cjs.Shape();
	this.shape_402.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_402.setTransform(7.5,7);

	this.addChild(this.shape_402,this.shape_401,this.shape_400,this.instance_38);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowUp_overSkin = function() {
	...
	this.shape_403.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-1,3.5,-1,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_403.setTransform(7.6,4.3);

	this.shape_404 = new cjs.Shape();
	this.shape_404.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_404.setTransform(7.5,7);

	this.shape_405 = new cjs.Shape();
	this.shape_405.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_405.setTransform(7.5,7);

	this.addChild(this.shape_405,this.shape_404,this.shape_403,this.instance_39);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowDown_upSkin = function() {
	...
	this.shape_406.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_406.setTransform(7.5,4.3);

	this.shape_407 = new cjs.Shape();
	this.shape_407.graphics.beginLinearGradientFill(["#5B5D5E","#B7BABC"],[0,1],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_407.setTransform(7.5,7);

	this.shape_408 = new cjs.Shape();
	this.shape_408.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_408.setTransform(7.5,7);

	this.addChild(this.shape_408,this.shape_407,this.shape_406,this.instance_40);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowDown_overSkin = function() {
	...
	this.shape_409.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_409.setTransform(7.5,4.3);

	this.shape_410 = new cjs.Shape();
	this.shape_410.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_410.setTransform(7.5,7);

	this.shape_411 = new cjs.Shape();
	this.shape_411.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_411.setTransform(7.5,7);

	this.addChild(this.shape_411,this.shape_410,this.shape_409,this.instance_41);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{static:0,running:8,running_back:37,jumping:66,falling:74,flying:82,flying_back:91,floating:100},true);
	...
	this.timeline.addTween(cjs.Tween.get(this.larm_d).wait(1).to({regX:13.8,regY:29.8,x:-13.6,y:21.5},0).wait(6).wait(1).to({regX:3.7,regY:8,x:-1.6,y:-0.1},0).wait(1).to({regX:13.8,regY:29.8,x:-11.6,y:21.8},0).wait(1).to({x:-11.4,y:22.1},0).wait(1).to({x:-11.1,y:22.5},0).wait(1).to({x:-10.9,y:23},0).wait(1).to({x:-11.2,y:22.7},0).wait(1).to({x:-11.5,y:22.4},0).wait(1).to({x:-11.6,y:22.1},0).wait(1).to({x:-11.7,y:21.8},0).wait(1).to({x:-11,y:22.4},0).wait(1).to({x:-10.4,y:23.1},0).wait(1).to({x:-10.5,y:23.4},0).wait(1).to({x:-10.7,y:23.8},0).wait(1).to({x:-10,y:24.5},0).wait(1).to({x:-9.4,y:25.2},0).wait(1).to({x:-9.6,y:25.1},0).wait(1).to({x:-9.9},0).wait(1).to({x:-9.6,y:25.3},0).wait(1).to({x:-9.4,y:25.6},0).wait(1).to({x:-9.8,y:25.5},0).wait(1).to({x:-10.2,y:25.4},0).wait(1).to({x:-10.4,y:25.3},0).wait(1).to({x:-10.6,y:25.2},0).wait(1).to({x:-11.1,y:24.7},0).wait(1).to({x:-11.7,y:24.2},0).wait(1).to({x:-11.3,y:24.4},0).wait(1).to({x:-11,y:24.6},0).wait(1).to({x:-10.9,y:22.5},0).wait(1).to({y:20.5},0).wait(1).to({regX:3.7,regY:8,x:-6.7,y:0.9},0).wait(1).to({regX:13.8,regY:29.8,x:-17,y:22.5},0).wait(1).to({x:-17.1,y:22.4},0).wait(1).to({x:-17.9},0).wait(1).to({x:-18.6,y:22.5},0).wait(1).to({x:-18.4,y:22.8},0).wait(1).to({x:-18.1,y:23.2},0).wait(1).to({x:-18.6,y:23.7},0).wait(1).to({x:-19,y:24.2},0).wait(1).to({x:-20,y:24.5},0).wait(1).to({x:-20.9,y:24.9},0).wait(1).to({x:-20.8,y:24.5},0).wait(1).to({x:-20.7,y:24.2},0).wait(1).to({x:-20.4,y:24.4},0).wait(1).to({x:-20,y:24.7},0).wait(1).to({x:-19.2,y:23.9},0).wait(1).to({x:-18.3,y:23.2},0).wait(1).to({x:-18.1,y:22.6},0).wait(1).to({x:-17.9,y:22},0).wait(1).to({x:-18,y:22.2},0).wait(1).to({x:-18.1,y:22.4},0).wait(1).to({y:22.7},0).wait(1).to({y:23},0).wait(1).to({x:-18,y:23.8},0).wait(1).to({x:-17.9,y:24.6},0).wait(1).to({x:-16.7,y:24.7},0).wait(1).to({x:-15.4,y:24.9},0).wait(1).to({x:-15.9,y:24.4},0).wait(1).to({x:-16.4,y:23.9},0).wait(1).to({regX:3.7,regY:8,x:-3,y:0.6},0).wait(1).to({regX:13.8,regY:29.8,x:-12.9,y:23},0).wait(1).to({x:-12.8,y:23.7},0).wait(1).to({x:-12.2},0).wait(1).to({x:-11.6,y:23.8},0).wait(3).wait(1).to({regX:3.7,regY:8,x:-1.1,y:0.4},0).wait(1).to({regX:13.8,regY:29.8,x:-12,y:21.9},0).wait(1).to({x:-12.8,y:21.6},0).wait(1).to({x:-14,y:22.2},0).wait(1).to({x:-15.2,y:22.8},0).wait(1).to({x:-14.9,y:22.9},0).wait(1).to({x:-14.6,y:23.1},0).wait(1).wait(1).to({regX:3.7,regY:8,x:-0.8,y:0.6},0).wait(1).to({regX:13.8,regY:29.8,x:-11,y:22},0).wait(1).to({x:-11.2,y:21.7},0).wait(1).to({x:-11.3,y:21.3},0).wait(1).to({x:-11.5,y:21},0).wait(1).to({x:-11.6,y:20.6},0).wait(1).to({x:-11.3,y:20.8},0).wait(1).to({x:-10.9,y:21.1},0).wait(1).to({x:-10.6,y:21.3},0).wait(1).to({regX:3.7,regY:8,x:-0.6,y:0.1},0).wait(1).to({regX:13.8,regY:29.8,x:-13.5,y:21.5},0).wait(1).to({x:-16.2,y:21.2},0).wait(1).to({x:-15.6,y:21.3},0).wait(1).to({x:-14.9,y:21.4},0).wait(1).to({x:-15.1,y:22.2},0).wait(1).to({x:-15.2,y:23.1},0).wait(1).to({x:-15.7,y:24.1},0).wait(1).to({x:-16.1,y:25.1},0).wait(1).to({regX:3.7,regY:8,x:-2.2,y:4.9},0).wait(1).to({regX:13.8,regY:29.8,x:-12.3,y:26.6},0).wait(1).to({y:26.5},0).wait(1).to({x:-12.2,y:26.4},0).wait(1).to({y:26.3},0).wait(1).to({y:26.2},0).wait(1).to({x:-12.1,y:26},0).wait(1).to({y:25.9},0).wait(1).to({y:25.8},0).wait(1).to({x:-12,y:25.7},0).wait(1).to({y:25.6},0).wait(1).to({x:-11.9,y:25.4},0).wait(1).to({x:-12,y:25.6},0).wait(1).to({y:25.7},0).wait(1).to({y:25.8},0).wait(1).to({x:-12.1,y:25.9},0).wait(1).to({y:26},0).wait(1).to({y:26.1},0).wait(1).to({x:-12.2,y:26.3},0).wait(1).to({y:26.4},0).wait(1).to({y:26.5},0).wait(1).to({x:-12.3,y:26.6},0).wait(1).to({y:26.7},0).wait(1).to({y:26.8},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.larm_l).wait(1).to({regX:5.5,regY:25.7,scaleX:1.15,scaleY:1,rotation:21.2,x:-7.5,y:23.8},0).wait(6).wait(1).to({regX:0.8,regY:4.6,scaleX:1.12,scaleY:1,rotation:44.9,x:-7.6,y:-1.3},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.12,scaleY:1,x:-18.5,y:17.4},0).wait(1).to({x:-18.3,y:17.7},0).wait(1).to({rotation:37.4,x:-14.6,y:19.4},0).wait(1).to({rotation:29.9,x:-10.8,y:20.8},0).wait(1).to({rotation:7.4,x:-1,y:21.8},0).wait(1).to({rotation:-15,x:8.1,y:19.5},0).wait(1).to({rotation:-15,x:10.4,y:21},0).wait(1).to({x:12.7,y:22.5},0).wait(1).to({rotation:-37.4,x:21,y:16.3},0).wait(1).to({rotation:-59.9,x:26.7,y:7.9},0).wait(1).to({rotation:-89.9,x:28.6,y:-5.5},0).wait(1).to({rotation:-120,x:24.7,y:-17.5},0).wait(1).to({x:24.9,y:-15.5},0).wait(1).to({x:25,y:-13.4},0).wait(1).to({rotation:-97.4,x:28.2,y:-4.8},0).wait(1).to({rotation:-74.9,x:28.3,y:4.9},0).wait(1).to({rotation:-44.9,x:23,y:16.5},0).wait(1).to({rotation:-15,x:12.7,y:25.1},0).wait(1).to({rotation:14.9,x:-2.6,y:25.7},0).wait(1).to({rotation:44.9,x:-18.1,y:20.4},0).wait(1).to({rotation:52.4,x:-21,y:16.9},0).wait(1).to({rotation:59.9,x:-23.6,y:13.1},0).wait(1).to({x:-24.1,y:12.7},0).wait(1).to({x:-24.7,y:12.3},0).wait(1).to({rotation:67.4,x:-26.2,y:9.2},0).wait(1).to({rotation:74.9,x:-27.4,y:5.9},0).wait(1).to({rotation:59.9,x:-23.6,y:12.1},0).wait(1).to({rotation:44.9,x:-18.7,y:17.1},0).wait(1).to({regX:0.8,regY:4.5,scaleX:1.12,scaleY:1,rotation:29.8,x:-12,y:1.1},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.12,scaleY:1,rotation:22.4,x:-14.2,y:23.1},0).wait(1).to({rotation:15,x:-10.5,y:23.7},0).wait(1).to({rotation:0,x:-4.3},0).wait(1).to({rotation:-14.9,x:1.3,y:22.3},0).wait(1).to({rotation:-7.4,x:-1.2,y:24.1},0).wait(1).to({rotation:0,x:-4.1,y:25.5},0).wait(1).to({rotation:0,y:25.9},0).wait(1).to({x:-4.2,y:26.3},0).wait(1).to({rotation:-14.9,x:4.1,y:24.5},0).wait(1).to({rotation:-29.9,x:12,y:21.3},0).wait(1).to({rotation:-44.9,x:16.3,y:16.2},0).wait(1).to({rotation:-60,x:19.4,y:10.3},0).wait(1).to({rotation:-74.9,x:20.9,y:3.9},0).wait(1).to({rotation:-89.9,x:20.8,y:-2.3},0).wait(1).to({x:21.7,y:-4.1},0).wait(1).to({x:22.7,y:-5.8},0).wait(1).to({rotation:-74.9,x:22.9,y:0.6},0).wait(1).to({rotation:-59.9,x:21.7,y:7.2},0).wait(1).to({rotation:-37.4,x:16.2,y:15.9},0).wait(1).to({rotation:-15,x:8,y:22.6},0).wait(1).to({rotation:-15,x:3.6,y:21.7},0).wait(1).to({x:-0.5,y:20.8},0).wait(1).to({rotation:3.7,x:-8.2,y:24.5},0).wait(1).to({rotation:22.6,x:-16.3,y:25.9},0).wait(1).to({rotation:33.8,x:-19.6,y:23.8},0).wait(1).to({rotation:44.9,x:-23.1,y:21},0).wait(1).to({x:-23.7,y:20.4},0).wait(1).to({x:-24.4,y:19.7},0).wait(1).to({regX:2,regY:4.4,scaleX:1.15,scaleY:1,rotation:-23.6,x:-0.7,y:1.1},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.15,scaleY:1,rotation:-31.2,x:14.3,y:17.2},0).wait(1).to({rotation:-38.6,x:16.9,y:15.2},0).wait(1).to({x:17.4,y:15.1},0).wait(1).to({x:17.9,y:15},0).wait(3).wait(1).to({regX:1.8,regY:4.8,scaleX:1.15,scaleY:1,rotation:126.1,x:-7.9,y:-9.6},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.15,scaleY:1,rotation:103.6,x:-30.1,y:-7.8},0).wait(1).to({rotation:81,x:-29.6,y:2.7},0).wait(1).to({rotation:58.6,x:-25.9,y:12.2},0).wait(1).to({rotation:36.2,x:-19.7,y:19.6},0).wait(1).to({x:-19.5,y:20},0).wait(1).to({x:-19.2,y:20.3},0).wait(1).wait(1).to({regX:2,regY:4.5,scaleX:1.15,scaleY:1,rotation:-38.6,x:1.4,y:0.9},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.15,scaleY:1,rotation:-28.6,x:14.3,y:17.5},0).wait(1).to({rotation:-18.6,x:10.3,y:19.6},0).wait(1).to({rotation:-8.6,x:6,y:21.1},0).wait(1).to({x:5.7,y:21.3},0).wait(1).to({x:5.4,y:21.5},0).wait(1).to({rotation:-13.6,x:7.6,y:20.9},0).wait(1).to({rotation:-18.6,x:9.8,y:20.1},0).wait(1).to({rotation:-23.6,x:12,y:19.2},0).wait(1).to({regX:2,regY:4.5,scaleX:1.15,scaleY:1,rotation:-38.6,x:1.4,y:0.9},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.15,scaleY:1,rotation:-53.6,x:18.9,y:10},0).wait(1).to({rotation:-68.6,x:18.5,y:4.3},0).wait(1).to({rotation:-31.2,x:10.9,y:18},0).wait(1).to({rotation:6.1,x:-2.4,y:25},0).wait(1).to({rotation:-1.2,x:0.3,y:24},0).wait(1).to({rotation:-8.7,x:3.2,y:22.7},0).wait(1).to({x:2.4,y:23.6},0).wait(1).to({rotation:-8.6,x:1.7,y:24.4},0).wait(1).to({regX:1.5,regY:4.8,scaleX:1.15,scaleY:1,rotation:21.1,x:-3.2,y:7.1},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1.15,scaleY:1,x:-6.4,y:28.2},0).wait(3).wait(1).to({x:-6.5,y:28.1},0).wait(3).wait(1).to({y:28},0).wait(3).wait(1).to({y:28.1},0).wait(2).wait(1).to({y:28.2},0).wait(2).wait(1).to({x:-6.4,y:28.3},0).wait(2).wait(1).to({y:28.4},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.rarm_d).wait(1).to({regX:13.8,regY:29.8,x:13.8,y:21.2},0).wait(6).wait(1).to({regX:2.6,regY:8.2,x:5,y:0},0).wait(1).to({regX:13.8,regY:29.8,x:16.4,y:21.9},0).wait(1).to({x:16.7,y:22.2},0).wait(1).to({y:22.5},0).wait(1).to({y:22.8},0).wait(1).to({x:16.3,y:22.4},0).wait(1).to({x:15.9,y:22},0).wait(1).to({x:15.6},0).wait(1).to({x:15.3},0).wait(1).to({x:15.9,y:22.7},0).wait(1).to({x:16.6,y:23.4},0).wait(1).to({x:16.1,y:23.7},0).wait(1).to({x:15.7,y:24},0).wait(1).to({x:16.1,y:24.5},0).wait(1).to({x:16.6,y:25},0).wait(1).to({x:16.5},0).wait(1).to({x:16.4,y:24.9},0).wait(1).to({x:16.7,y:25},0).wait(1).to({x:17,y:25.2},0).wait(1).to({x:16.8},0).wait(1).to({x:16.5},0).wait(1).to({x:16.6,y:25.5},0).wait(1).to({x:16.7,y:25.7},0).wait(1).to({x:15.9},0).wait(1).to({x:15.2},0).wait(1).to({x:15.6,y:25.2},0).wait(1).to({x:16,y:24.7},0).wait(1).to({x:16.2,y:22.7},0).wait(1).to({x:16.5,y:20.7},0).wait(1).to({regX:2.6,regY:8.2,x:-1.5,y:0.9},0).wait(1).to({regX:13.8,regY:29.8,x:9.2,y:22.4},0).wait(1).to({x:8.8,y:22.2},0).wait(1).to({x:8.2,y:22.4},0).wait(1).to({x:7.5,y:22.6},0).wait(1).to({x:7.8,y:22.8},0).wait(1).to({x:8.1,y:23},0).wait(1).to({x:7.6,y:23.4},0).wait(1).to({x:7.1,y:23.7},0).wait(1).to({x:6.2,y:24.1},0).wait(1).to({x:5.3,y:24.4},0).wait(1).to({x:5.4},0).wait(1).to({x:5.5},0).wait(1).to({x:5.8,y:24.7},0).wait(1).to({x:6.1,y:24.9},0).wait(1).to({x:6.9,y:23.6},0).wait(1).to({x:7.7,y:22.3},0).wait(1).to({x:8.3,y:22},0).wait(1).to({x:8.8,y:21.6},0).wait(1).to({x:8.5,y:21.7},0).wait(1).to({x:8.3,y:21.8},0).wait(1).to({x:8.1,y:22.2},0).wait(1).to({x:7.8,y:22.5},0).wait(1).to({x:7.9,y:23.4},0).wait(1).to({x:8,y:24.3},0).wait(1).to({x:9.4,y:24.5},0).wait(1).to({x:10.8,y:24.7},0).wait(1).to({x:10.1,y:24.1},0).wait(1).to({x:9.3,y:23.4},0).wait(1).to({regX:2.6,regY:8.2,x:2.9,y:1.5},0).wait(1).to({regX:13.8,regY:29.8,x:14.4,y:23.8},0).wait(1).to({x:14.6,y:24.4},0).wait(1).to({x:15,y:24},0).wait(1).to({x:15.4,y:23.6},0).wait(3).wait(1).to({regX:2.6,regY:8.2,x:4.8,y:0.5},0).wait(1).to({regX:13.8,regY:29.8,x:15.1,y:22.1},0).wait(1).to({x:14.2},0).wait(1).to({x:13.2,y:22.5},0).wait(1).to({x:12.2,y:22.9},0).wait(1).to({x:12.5,y:23.3},0).wait(1).to({x:12.8,y:23.7},0).wait(1).wait(1).to({regX:2.6,regY:8.2,x:5.8,y:0.1},0).wait(1).to({regX:13.8,regY:29.8,x:16.7,y:21.4},0).wait(1).to({x:16.5,y:21},0).wait(1).to({x:16.2,y:20.7},0).wait(1).to({x:16,y:20.3},0).wait(1).to({x:15.7,y:20},0).wait(1).to({x:16,y:20.3},0).wait(1).to({x:16.3,y:20.6},0).wait(1).to({x:16.6,y:20.8},0).wait(1).to({regX:2.6,regY:8.2,x:5.1,y:-0.1},0).wait(1).to({regX:13.8,regY:29.8,x:13.4,y:21.2},0).wait(1).to({x:10.4},0).wait(1).to({x:11.1,y:20.9},0).wait(1).to({x:11.8,y:20.6},0).wait(1).to({x:11.5,y:21.3},0).wait(1).to({x:11.3,y:21.9},0).wait(1).to({x:10.8,y:23.1},0).wait(1).to({x:10.3,y:24.2},0).wait(1).to({regX:2.6,regY:8.2,x:3.4,y:5.3},0).wait(1).to({regX:13.8,regY:29.8,x:14.6,y:26.8},0).wait(1).to({y:26.6},0).wait(1).to({y:26.5},0).wait(1).to({y:26.3},0).wait(1).to({y:26.1},0).wait(1).to({y:26},0).wait(1).to({y:25.8},0).wait(1).to({y:25.6},0).wait(1).to({y:25.5},0).wait(1).to({y:25.3},0).wait(1).to({x:14.7,y:25.1},0).wait(1).to({x:14.6,y:25.3},0).wait(1).to({y:25.4},0).wait(1).to({y:25.5},0).wait(1).to({y:25.7},0).wait(1).to({y:25.8},0).wait(1).to({y:25.9},0).wait(1).to({y:26.1},0).wait(1).to({y:26.2},0).wait(1).to({y:26.3},0).wait(1).to({y:26.5},0).wait(1).to({y:26.6},0).wait(1).to({y:26.7},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.rarm_l).wait(1).to({regX:5.5,regY:25.7,x:11.2,y:22.2},0).wait(6).wait(1).to({regX:0.7,regY:3.6,rotation:-104.8,x:8.7,y:-1.2},0).wait(1).to({regX:5.5,regY:25.7,x:28.2,y:-11.2},0).wait(1).to({x:27.5,y:-10.8},0).wait(1).to({rotation:-89.8,x:28.7,y:-4.4},0).wait(1).to({rotation:-74.8,x:28.3,y:2.2},0).wait(1).to({rotation:-44.8,x:22.5,y:13.9},0).wait(1).to({rotation:-14.8,x:11.7,y:22.3},0).wait(1).to({rotation:0,x:3,y:23},0).wait(1).to({rotation:15.1,x:-6,y:22.2},0).wait(1).to({rotation:37.5,x:-15.7,y:18},0).wait(1).to({rotation:60,x:-23.9,y:10.5},0).wait(1).to({rotation:67.6,x:-26.3,y:6.7},0).wait(1).to({rotation:75.1,x:-28.4,y:2.6},0).wait(1).to({rotation:67.7,x:-25.7,y:7.2},0).wait(1).to({rotation:60.2,x:-22.7,y:11.4},0).wait(1).to({rotation:52.7,x:-20.4,y:15.6},0).wait(1).to({rotation:45.2,x:-17.7,y:19.5},0).wait(1).to({rotation:22.7,x:-7.9,y:24.2},0).wait(1).to({rotation:0.1,x:2.3,y:25.6},0).wait(1).to({rotation:-29.7,x:16.2,y:21.4},0).wait(1).to({rotation:-59.8,x:26.1,y:12.7},0).wait(1).to({rotation:-74.8,x:28.1,y:6.1},0).wait(1).to({rotation:-89.7,x:28.6,y:-0.3},0).wait(1).to({rotation:-97.3,x:27.6,y:-3.9},0).wait(1).to({rotation:-104.8,x:26.2,y:-7.4},0).wait(1).to({x:26.7,y:-7.8},0).wait(1).to({x:27.1,y:-8.2},0).wait(1).to({x:27.9,y:-9.9},0).wait(1).to({x:28.8,y:-11.5},0).wait(1).to({regX:1,regY:2.6,x:1,y:-0.6},0).wait(1).to({regX:5.5,regY:25.7,x:22.3,y:-10.9},0).wait(1).to({x:22.5,y:-10.7},0).wait(1).to({x:21.7,y:-10.8},0).wait(1).to({x:20.8},0).wait(1).to({rotation:-97.3,x:21.1,y:-6.9},0).wait(1).to({rotation:-89.7,x:21,y:-2.9},0).wait(1).to({rotation:-74.8,x:19.3,y:4.3},0).wait(1).to({rotation:-59.8,x:16,y:11.6},0).wait(1).to({rotation:-29.7,x:6.3,y:21.8},0).wait(1).to({rotation:0.1,x:-7.2,y:27.2},0).wait(1).to({rotation:22.7,x:-18.2,y:25.1},0).wait(1).to({rotation:45.2,x:-28.5,y:19.6},0).wait(1).to({rotation:37.7,x:-24.8,y:22.4},0).wait(1).to({rotation:30.2,x:-21,y:24.9},0).wait(1).to({x:-19.5,y:24},0).wait(1).to({x:-18,y:23},0).wait(1).to({x:-18.4,y:22.7},0).wait(1).to({rotation:30.1,x:-18.7,y:22.3},0).wait(1).to({rotation:22.6,x:-14.7,y:23.7},0).wait(1).to({rotation:15.1,x:-10.6,y:24.7},0).wait(1).to({rotation:0,x:-1.6,y:24.5},0).wait(1).to({rotation:-14.8,x:6.8,y:22.9},0).wait(1).to({rotation:-44.8,x:17.7,y:15.5},0).wait(1).to({rotation:-74.8,x:23.3,y:4.7},0).wait(1).to({rotation:-89.8,x:24.3,y:-1.8},0).wait(1).to({rotation:-104.8,x:23.6,y:-8.2},0).wait(1).to({rotation:-108.5,x:23.3,y:-11.3},0).wait(1).to({rotation:-112.3,x:22.8,y:-14.3},0).wait(1).to({regX:2.1,regY:5.8,scaleX:1,scaleY:1,rotation:52.7,x:-7.4,y:-4.1},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1,scaleY:1,rotation:52.7,x:-21,y:10.7},0).wait(1).to({x:-20.9,y:11},0).wait(1).to({x:-20.4,y:11.2},0).wait(1).to({x:-19.9,y:11.5},0).wait(3).wait(1).to({regX:2.6,regY:5.6,scaleX:1,scaleY:1,rotation:-112.1,x:13,y:-11.4},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1,scaleY:1,rotation:-104.6,x:31,y:-18.1},0).wait(1).to({rotation:-97.1,x:31.3,y:-14.3},0).wait(1).to({rotation:-82.1,x:31.5,y:-7.6},0).wait(1).to({rotation:-67.1,x:30.4,y:-0.8},0).wait(1).to({x:30.2},0).wait(1).to({rotation:-67.2,y:-0.7},0).wait(1).wait(1).to({regX:1.6,regY:5.9,scaleX:1,scaleY:1,rotation:37.6,x:-5.6,y:-2.3},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1,scaleY:1,rotation:39.6,x:-15.5,y:15.2},0).wait(1).to({rotation:41.5,x:-16.4,y:14.9},0).wait(1).to({rotation:43.4,x:-17.2,y:14.4},0).wait(1).to({rotation:45.3,x:-18.1,y:13.7},0).wait(1).to({rotation:47.2,x:-19,y:13.1},0).wait(1).to({rotation:54,x:-20.7,y:11.2},0).wait(1).to({rotation:60.8,x:-22.2,y:9},0).wait(1).to({rotation:67.7,x:-23.4,y:6.6},0).wait(1).to({regX:1.8,regY:6,scaleX:1,scaleY:1,rotation:52.7,x:-5.6,y:-1.5},0).wait(1).to({regX:5.5,regY:25.7,scaleX:1,scaleY:1,rotation:30.1,x:-12.5,y:20.1},0).wait(1).to({rotation:7.6,x:-4.9,y:24.2},0).wait(1).to({rotation:-7.2,x:5.3,y:22.8},0).wait(1).to({rotation:-22.1,x:15.2,y:20.2},0).wait(1).to({rotation:-29.6,x:18,y:17.7},0).wait(1).to({rotation:-37.1,x:20.7,y:15.1},0).wait(1).to({rotation:-52.1,x:24.4,y:10.8},0).wait(1).to({rotation:-67.2,x:26.9,y:5.8},0).wait(1).to({regX:0.1,regY:3,rotation:-7.1,x:4.2,y:6.2},0).wait(1).to({regX:5.5,regY:25.7,rotation:-7.1,x:12.5,y:28},0).wait(1).wait(1).to({x:12.6,y:27.9},0).wait(1).wait(1).to({x:12.7,y:27.8},0).wait(1).wait(1).to({x:12.8,y:27.7},0).wait(1).wait(1).to({x:12.9,y:27.6},0).wait(1).wait(1).to({x:13,y:27.5},0).wait(1).to({y:27.6},0).wait(1).to({y:27.7},0).wait(1).to({y:27.8},0).wait(1).to({x:12.9},0).wait(1).to({y:27.9},0).wait(1).to({y:28},0).wait(1).to({y:28.1},0).wait(1).wait(1).to({y:28.2},0).wait(1).to({y:28.3},0).wait(1).to({y:28.4},0).wait(1).to({x:12.8},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-31.6,-30.8,63.3,85.6);
...
p.nominalBounds = new cjs.Rectangle(-63,-78.2,124.1,132.5);
...
(lib.giftedclientcharScreen = function() {
	...
	this.shape_412.graphics.beginRadialGradientFill(["#9487B2","#523D83"],[0,1],0,0,0,0,0,118.1).beginStroke().moveTo(-82.4,-13.5).curveTo(-48.3,-19.1,0,-19.1).curveTo(48.3,-19.1,82.4,-13.5).curveTo(116.5,-7.8,116.5,0).curveTo(116.5,7.9,82.4,13.5).curveTo(48.3,19.1,0,19.1).curveTo(-48.3,19.1,-82.4,13.5).curveTo(-116.5,7.9,-116.5,0).curveTo(-116.5,-7.8,-82.4,-13.5).closePath();
	this.shape_412.setTransform(504.7,219.2);

	// Back
	this.instance_75 = new lib.mcCharScreen_bg("single",0);
	this.instance_75.setTransform(332.2,139.2,1,1,0,0,0,0,-139.1);

	this.addChild(this.instance_75,this.shape_412,this.btnHeadNext,this.btnHeadPrev,this.displayHead,this.text_2,this.btnSave,this.btnCancel,this.displayMain);
}).prototype = p = new cjs.Container();
