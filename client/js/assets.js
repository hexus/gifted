...
(lib.ElvenDagger = function() {
	...
	this.shape_42.graphics.beginFill("#DCB67C").beginStroke().moveTo(0.3,-0.6).curveTo(0.3,-0.6,0.3,-0.6).lineTo(0.4,-0.9).curveTo(0.7,-0.2,0.7,0.9).curveTo(0.5,0.9,0.2,0.8).curveTo(-0.2,0.7,-0.3,0.6).curveTo(-0.6,0.1,-0.7,-0.2).curveTo(-0.6,-0.2,-0.6,-0.2).curveTo(-0.3,0.1,-0.2,0.1).lineTo(-0.1,-0.1).closePath();
...
(lib.mcFlybot_turret = function() {
	...
	this.shape_283.setTransform(7.6,2.3);

	this.shape_284 = new cjs.Shape();
	this.shape_284.graphics.beginFill("#660000").beginStroke().moveTo(5.3,-1.3).curveTo(5.6,-1.3,5.8,-1.4).curveTo(6,-1.3,6.2,-1.3).curveTo(6.1,-1.1,6.1,-0.8).curveTo(6.1,-0,6.2,1.3).lineTo(0.7,1.4).curveTo(-1.9,1.2,-2.2,1.1).lineTo(-6.2,1).lineTo(-6.2,-0.7).lineTo(-2.2,-0.8).curveTo(-2,-0.8,-1.9,-0.9).lineTo(2,-0.9).curveTo(3,-1.1,5.3,-1.3).closePath();
	this.shape_284.setTransform(7.5,2.3);

	this.addChild(this.shape_284,this.shape_283);
}).prototype = p = new cjs.Container();
...
(lib.mcFlybot_body = function() {
	...
	this.shape_291.graphics.beginFill("#000000").beginStroke().moveTo(-3.7,-1.6).lineTo(-3.5,-1.6).curveTo(-3.1,-1,-3.1,0.3).lineTo(-3.2,2.4).curveTo(-2.9,2.4,-2.9,2.8).curveTo(-2.9,3.3,-3.3,3.3).curveTo(-3.8,3.3,-3.8,3).curveTo(-3.8,2.8,-3.8,2.8).curveTo(-3.8,2.4,-3.5,2.3).curveTo(-3.5,1.6,-3.4,0.3).curveTo(-3.4,-0.3,-3.7,-1).closePath().moveTo(1.5,-3.2).curveTo(1.5,-3.8,2.7,-3.8).curveTo(3.8,-3.8,3.8,-3.2).curveTo(2.5,3.6,2,3.6).curveTo(2,3.6,2,3.6).lineTo(1.9,3.8).curveTo(1.6,3.8,1.5,3.4).curveTo(1.5,3.4,1.5,3.3).curveTo(1.4,3.1,1.4,2.9).lineTo(1.4,2).curveTo(1.4,0.6,1.6,0).curveTo(1.7,-0.6,1.7,-1.4).curveTo(1.7,-1.8,1.5,-2.8).curveTo(1.5,-3,1.5,-3.2).closePath();
	this.shape_291.setTransform(5.5,0.2);

	// Top Legs
	this.shape_292 = new cjs.Shape();
	this.shape_292.graphics.beginFill("#000000").beginStroke().moveTo(-6.7,-1.4).curveTo(-6.7,-2.5,-6.1,-2.8).curveTo(-5.6,-3.2,-5.6,-2.1).lineTo(-5.8,0.5).curveTo(-5.8,0.8,-5.2,2.4).curveTo(-5.2,2.9,-5.6,2.9).curveTo(-6.5,2.9,-6.7,1.8).curveTo(-6.7,0.6,-6.7,0.6).closePath().moveTo(5.9,-2).curveTo(6.3,-2.5,6.4,-1.3).curveTo(6.4,-0.6,6.6,0.1).curveTo(6.7,0.8,6.7,1).curveTo(6.7,1.5,6.2,1.5).curveTo(5.2,1.5,5.5,-0.6).curveTo(5.5,-1.4,5.9,-2).closePath();
	this.shape_292.setTransform(7.4,14.5);

	// Shape
	this.shape_293 = new cjs.Shape();
	this.shape_293.graphics.beginFill("#000000").beginStroke().moveTo(10,1.3).curveTo(10,3.5,8.9,5.6).curveTo(7.8,7.9,6.3,7.4).lineTo(2.5,7.4).lineTo(2.4,7.5).lineTo(-6.4,7.5).curveTo(-7.8,7.3,-8.5,6.3).curveTo(-8.9,5.8,-9.4,4.7).lineTo(-9.4,-1.5).curveTo(-10,-3.6,-10,-4.8).curveTo(-10,-6.3,-9.7,-6.7).curveTo(-8.9,-7.5,-5.9,-7.5).curveTo(-3.3,-7.5,0.6,-5.8).curveTo(2.7,-4.9,4.9,-3.9).curveTo(8,-3,9.2,-1.5).curveTo(10,-0.4,10,1.3).closePath().moveTo(7.7,-1.2).curveTo(5.4,-2,2.9,-3.4).curveTo(-0.2,-5,-4.1,-5.8).curveTo(-8.8,-6.8,-8.8,-4.8).curveTo(-8.8,-4.2,-8.7,-3.3).curveTo(-8.3,-2.3,-8.3,-1.8).lineTo(-8.3,4.3).curveTo(-7.8,5.2,-7.5,5.5).curveTo(-7.1,6.1,-6,6.3).lineTo(2,6.3).lineTo(2.3,6.1).lineTo(5.9,6.1).curveTo(7.1,5.9,7.9,5.2).curveTo(8.5,4.4,8.4,3.8).curveTo(8.3,3.2,8.5,2.5).curveTo(8.8,1.8,8.8,1.3).curveTo(8.8,-0.6,7.7,-1.2).closePath();
	this.shape_293.setTransform(10,7.5);

	this.shape_294 = new cjs.Shape();
	this.shape_294.graphics.beginFill("#990000").beginStroke().moveTo(7.7,-1.2).curveTo(8.8,-0.7,8.8,1.2).curveTo(8.8,1.7,8.5,2.4).curveTo(8.3,3.1,8.4,3.8).curveTo(8.5,4.4,7.9,5.1).curveTo(7.2,5.9,5.9,6).lineTo(2.3,6).lineTo(2,6.2).lineTo(-6,6.2).curveTo(-7.1,6,-7.5,5.4).curveTo(-7.8,5.1,-8.2,4.2).lineTo(-8.2,-1.9).curveTo(-8.3,-2.4,-8.6,-3.4).curveTo(-8.8,-4.2,-8.8,-4.9).curveTo(-8.8,-6.9,-4.1,-5.9).curveTo(-0.1,-5.1,2.9,-3.5).curveTo(5.4,-2.1,7.7,-1.2).closePath();
	this.shape_294.setTransform(10,7.6);

	// Bototm Legs
	this.shape_295 = new cjs.Shape();
	this.shape_295.graphics.beginFill("#000000").beginStroke().moveTo(-6.1,0.7).curveTo(-6,0.9,-6,1.3).curveTo(-6,2.1,-6.4,2.1).curveTo(-6.8,2.1,-6.9,1.7).lineTo(-6.9,1.3).curveTo(-6.9,0.9,-6.8,0.7).curveTo(-6.9,0.6,-6.9,0.3).curveTo(-6.9,-0.2,-6.9,-0.3).curveTo(-6.9,-1.6,-6.4,-1.6).curveTo(-6,-1.6,-6,-0.3).curveTo(-6,0.4,-6.1,0.7).closePath().moveTo(6.6,0.3).curveTo(6.8,0.6,6.9,1).curveTo(6.9,1.6,6.5,1.6).curveTo(5.9,1.6,5.8,1.1).curveTo(5.8,1,5.8,0.9).curveTo(5.6,0.8,5.6,0.5).curveTo(5.8,0.1,5.8,-0.2).curveTo(5.8,-0.5,5.5,-0.8).curveTo(5.3,-1.2,5.3,-1.5).curveTo(5.3,-2.6,6,-1.7).curveTo(6.7,-0.8,6.7,-0.1).curveTo(6.7,0.1,6.6,0.3).closePath();
	this.shape_295.setTransform(11.4,14);

	this.addChild(this.shape_295,this.shape_294,this.shape_293,this.shape_292,this.shape_291);
}).prototype = p = new cjs.Container();
...
(lib.mcPhysObj_hitbox = function() {
	...
	this.shape_296.graphics.beginFill("#000000").beginStroke().moveTo(15,-15).lineTo(15,15).lineTo(-15,15).lineTo(-15,-15).closePath();

	this.addChild(this.shape_296);
}).prototype = p = new cjs.Container();
...
(lib.mcCharacter_hitbox = function() {
	...
	this.shape_297.graphics.beginFill().beginStroke("#000000").setStrokeStyle(1,1,1).moveTo(12.5,-30).lineTo(12.5,30).lineTo(-12.5,30).lineTo(-12.5,-30).closePath();
	this.shape_297.setTransform(15,30);

	this.addChild(this.shape_297);
}).prototype = p = new cjs.Container();
...
(lib.ScrollArrowUp_downSkin = function() {
	...
	this.shape_344.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-1,3.5,-1,-3.1).beginStroke().moveTo(6.5,3.3).lineTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).closePath();
	this.shape_344.setTransform(7.6,4.3);

	this.shape_345 = new cjs.Shape();
	this.shape_345.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).lineTo(6.5,-6).closePath();
	this.shape_345.setTransform(7.5,7);

	this.shape_346 = new cjs.Shape();
	this.shape_346.graphics.beginLinearGradientFill(["#99D7FE","#D9F0FE"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).lineTo(6.5,-6).closePath();
	this.shape_346.setTransform(7.5,7);

	this.addChild(this.shape_346,this.shape_345,this.shape_344,this.instance_10);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowDown_downSkin = function() {
	...
	this.shape_347.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_347.setTransform(7.5,4.3);

	this.shape_348 = new cjs.Shape();
	this.shape_348.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(-6.5,-6).lineTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).closePath().moveTo(-7.5,7).lineTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).closePath();
	this.shape_348.setTransform(7.5,7);

	this.shape_349 = new cjs.Shape();
	this.shape_349.graphics.beginLinearGradientFill(["#99D7FE","#D9F0FE"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(-6.5,-6).lineTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).closePath();
	this.shape_349.setTransform(7.5,7);

	this.addChild(this.shape_349,this.shape_348,this.shape_347,this.instance_12);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.head = function(mode,startPosition,loop) {
	...
	this.shape_358.setTransform(0,-21.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_352},{t:this.shape_351}]}).to({state:[{t:this.shape_354},{t:this.shape_353}]},5).to({state:[{t:this.shape_356},{t:this.shape_355}]},5).to({state:[{t:this.shape_358},{t:this.shape_357}]},5).wait(5));
...
(lib.arm_lower = function(mode,startPosition,loop) {
	...
	this.shape_359.graphics.beginFill("#000000").beginStroke().moveTo(-1.3,-4).lineTo(-1.3,-4).curveTo(-1.3,-3.9,-1.3,-3.8).curveTo(-1.3,-3.8,-1.3,-3.7).lineTo(-1.3,-3.6).curveTo(-1.1,-3.4,-1.1,-3.1).curveTo(-1,-2.7,-1,-2).curveTo(-0.8,-0.7,-0.7,0.1).curveTo(-0.7,1,-0.7,1.1).curveTo(-0.6,1.3,-0.5,2.4).curveTo(-0.4,3.1,-0.2,3.7).lineTo(0.3,4.9).curveTo(0.8,5.3,1.2,3.9).curveTo(1.2,3.8,1.2,3.7).curveTo(1.2,3.1,1.3,2.7).curveTo(1.2,2.5,1.2,2.4).curveTo(1.2,2.3,1.2,2.2).curveTo(1.1,1,1,0.1).curveTo(1,-0,1,-0.1).lineTo(0.7,-2.4).curveTo(0.7,-2.5,0.7,-2.6).curveTo(0.7,-2.6,0.7,-2.7).curveTo(0.7,-2.9,0.6,-3.2).curveTo(0.6,-3.5,0.5,-3.7).curveTo(0.5,-4.7,-0.3,-4.9).curveTo(-0.8,-5.1,-1,-4.7).curveTo(-1.3,-4.8,-1.3,-4).closePath();
	this.shape_359.setTransform(1.8,4.8);

	this.shape_360 = new cjs.Shape();
	this.shape_360.graphics.beginFill("#000000").beginStroke().moveTo(1.5,3.8).curveTo(1.5,4,1.3,4.3).curveTo(0.9,4.7,0.5,4.7).curveTo(-0.8,4.7,-0.8,3.1).curveTo(-0.7,1.3,-0.9,0.9).curveTo(-1.1,0.5,-1.3,-1.2).curveTo(-1.5,-2.6,-1.5,-3).curveTo(-1.5,-5,-0.4,-4.6).curveTo(0.8,-4.2,0.6,-1.5).curveTo(0.6,-1.3,1,1).curveTo(1.5,3.3,1.5,3.8).closePath();
	this.shape_360.setTransform(1.9,4.5);

	this.shape_361 = new cjs.Shape();
	this.shape_361.graphics.beginFill("#000000").beginStroke().moveTo(-1.1,0.8).curveTo(-1.3,-1.2,-1.3,-3.1).curveTo(-1.3,-3.9,-0.6,-4.5).curveTo(0.1,-5.1,0.3,-3.7).curveTo(0.3,-3,0.5,-1.3).curveTo(0.7,0.1,1,1.6).curveTo(1.3,2.9,1.3,3.6).curveTo(1.3,4.7,0.5,4.7).curveTo(-0.6,4.7,-1.1,0.8).closePath();
	this.shape_361.setTransform(1.7,4.4);

	this.shape_362 = new cjs.Shape();
	this.shape_362.graphics.beginFill("#000000").beginStroke().moveTo(-0.2,3).curveTo(-0.1,1.9,-0.2,1.6).curveTo(-0.3,1.1,-0.9,-1.1).curveTo(-1.4,-2.8,-1.4,-4).curveTo(-1.4,-4.7,-0.4,-4.7).curveTo(0.5,-4.7,0.7,-3.3).curveTo(0.7,-1.6,0.8,-1.2).curveTo(1.4,1.1,1.4,2.3).curveTo(1.4,3.3,1.2,4).curveTo(0.8,5.2,0.1,4.4).curveTo(-0.3,3.9,-0.2,3).closePath();
	this.shape_362.setTransform(1.7,4.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_359}]}).to({state:[{t:this.shape_360}]},5).to({state:[{t:this.shape_361}]},5).to({state:[{t:this.shape_362}]},5).wait(5));
...
(lib.mcPlayer_static_head = function(mode,startPosition,loop) {
	...
	this.shape_363.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0,-7.3).curveTo(5.5,-6.1,6.8,-4.4).curveTo(7.3,-3.9,7.3,-1.2).curveTo(7.3,-0.4,7.2,0.2).curveTo(6.8,1.4,6.1,2.8).curveTo(5.8,3.4,5.5,3.9).curveTo(4.8,5,4,5.8).curveTo(3.4,6.5,2.7,7).curveTo(2.5,7.2,2.3,7.3).lineTo(0,7.3).curveTo(-0.5,7.2,-1,7).curveTo(-4.4,6,-5.9,4.6).curveTo(-7.3,3.3,-7.3,1.4).curveTo(-7.3,0.8,-6.3,-3.4).curveTo(-6.2,-3.5,-6.1,-3.7).curveTo(-5.9,-4.1,-5.6,-4.4).curveTo(-5.1,-4.8,-4.1,-5.3).curveTo(-1.5,-6.7,-0.6,-7.3).curveTo(-0.3,-7.3,0,-7.3).closePath();
	this.shape_363.setTransform(0,-22);

	this.shape_364 = new cjs.Shape();
	this.shape_364.graphics.beginFill("#000000").beginStroke().moveTo(8.9,-5.8).lineTo(9,-3.8).curveTo(9.2,-3.1,9.2,-2.4).curveTo(9.2,-2,9.1,-1.5).lineTo(9.2,-0.8).curveTo(9.2,1.4,7.6,4.7).curveTo(6.9,6.2,6.1,7.2).curveTo(4.2,9.5,1.5,9.5).curveTo(-1.9,9.5,-4.2,8.5).curveTo(-5.9,8.1,-7,7.2).curveTo(-7.8,6.6,-8.3,5.7).curveTo(-9,4.6,-9.1,2.6).curveTo(-9.2,1.5,-9.1,0.4).curveTo(-9.1,-3,-8.3,-4.3).curveTo(-6.8,-6.7,-1.2,-9.1).curveTo(1,-10.1,4.9,-8.6).curveTo(8.5,-7.2,8.9,-5.8).closePath().moveTo(0,-7.2).curveTo(-0.3,-7.2,-0.6,-7.1).curveTo(-1.4,-6.5,-4.1,-5.2).curveTo(-5.1,-4.7,-5.6,-4.3).curveTo(-5.9,-3.9,-6.1,-3.5).curveTo(-6.2,-3.4,-6.2,-3.3).curveTo(-7.2,0.9,-7.2,1.6).curveTo(-7.2,3.5,-5.9,4.8).curveTo(-4.4,6.1,-1,7.2).curveTo(-0.5,7.3,0,7.5).lineTo(2.3,7.5).curveTo(2.5,7.3,2.7,7.2).curveTo(3.4,6.7,4.1,6).curveTo(4.8,5.2,5.5,4.1).curveTo(5.8,3.6,6.1,3).curveTo(6.8,1.6,7.2,0.4).curveTo(7.3,-0.3,7.3,-1).curveTo(7.3,-3.7,6.8,-4.3).curveTo(5.6,-5.9,0,-7.2).closePath();
	this.shape_364.setTransform(0,-22.1);

	this.shape_365 = new cjs.Shape();
	this.shape_365.graphics.beginFill("#000000").beginStroke().moveTo(6.2,-7.3).curveTo(8.9,-5.4,8.9,-2.5).curveTo(8.9,-0.1,7,3.4).curveTo(6,5.3,4.5,6.6).curveTo(2.4,8.9,-0.7,9.1).lineTo(-0.7,9.1).curveTo(-0.7,9.1,-0.8,9.1).curveTo(-1,9.1,-1.1,9.2).curveTo(-1.2,9.2,-1.3,9.1).lineTo(-1.8,9.1).curveTo(-1.8,9.1,-1.9,9.1).curveTo(-2,9.1,-2.1,9.1).lineTo(-2,9.1).curveTo(-3.8,8.9,-5.3,8).curveTo(-7.5,7.2,-8.3,5.3).curveTo(-8.4,5.1,-8.4,4.8).curveTo(-8.9,4,-8.9,3.5).curveTo(-8.9,2.3,-8.6,0.7).curveTo(-8.3,-3.9,-5.9,-6.6).curveTo(-3.5,-9.1,0.2,-9.2).curveTo(3.6,-9.3,6.2,-7.3).closePath().moveTo(5.1,-5.3).curveTo(3.5,-6.6,1.3,-6.9).curveTo(0.6,-6.9,-0.2,-6.7).curveTo(-1.7,-6.4,-2.9,-5.7).curveTo(-5.2,-3.2,-5.7,-2.5).curveTo(-6.7,-0.9,-6.7,1.7).curveTo(-6.7,3.4,-6.5,3.7).curveTo(-6.3,4.3,-4,6.6).lineTo(1.3,6.6).curveTo(3.7,4.7,5.2,2.4).curveTo(6.8,-0.9,6.8,-2.5).curveTo(6.8,-3.1,6.7,-3.6).curveTo(6.2,-4.4,5.1,-5.3).closePath();
	this.shape_365.setTransform(0.7,-22);

	this.shape_366 = new cjs.Shape();
	this.shape_366.graphics.beginFill("#FFFFFF").beginStroke().moveTo(5,-5.1).curveTo(6.1,-4.2,6.6,-3.5).curveTo(6.8,-3,6.8,-2.4).curveTo(6.8,-0.8,5.2,2.5).curveTo(3.6,4.9,1.3,6.8).lineTo(-4,6.8).curveTo(-6.3,4.5,-6.6,3.9).curveTo(-6.8,3.6,-6.8,1.9).curveTo(-6.8,-0.7,-5.8,-2.3).curveTo(-5.3,-3.1,-3,-5.6).curveTo(-1.8,-6.2,-0.3,-6.6).curveTo(0.5,-6.8,1.3,-6.8).curveTo(3.4,-6.5,5,-5.1).closePath();
	this.shape_366.setTransform(0.8,-22.2);

	this.shape_367 = new cjs.Shape();
	this.shape_367.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0,-6.7).curveTo(0.1,-6.7,0.2,-6.8).curveTo(3.7,-6.3,5.4,-5.4).curveTo(6.8,-4.1,6.8,-1.8).curveTo(6.8,-1.1,6.5,-0.1).curveTo(6.1,1.2,5.5,2.4).curveTo(3.4,6.8,0.3,6.8).curveTo(0.2,6.8,0,6.4).curveTo(-0.1,6.1,-3,6).curveTo(-3.6,5.3,-5.5,3.3).curveTo(-6.1,2.5,-6.5,1.9).curveTo(-6.8,0.7,-6.8,-0.8).curveTo(-6.8,-0.9,-6.8,-1).curveTo(-6.6,-1.4,-6.5,-1.7).curveTo(-6,-3,-5.5,-3.5).curveTo(-5.2,-4,-3.5,-5.2).curveTo(-2.9,-5.7,-2.5,-6.1).curveTo(-1.3,-6.6,0,-6.7).closePath();
	this.shape_367.setTransform(0.3,-21.9);

	this.shape_368 = new cjs.Shape();
	this.shape_368.graphics.beginFill("#000000").beginStroke().moveTo(0,-6.6).curveTo(-1.3,-6.4,-2.5,-5.9).curveTo(-2.9,-5.5,-3.5,-5).curveTo(-5.2,-3.8,-5.5,-3.4).curveTo(-6,-2.9,-6.5,-1.6).curveTo(-6.6,-1.2,-6.8,-0.9).curveTo(-6.8,-0.7,-6.8,-0.6).curveTo(-6.8,0.9,-6.5,2).curveTo(-6.1,2.7,-5.5,3.4).curveTo(-3.6,5.5,-3,6.2).curveTo(-0.1,6.2,0,6.6).curveTo(0.2,6.9,0.3,6.9).curveTo(3.4,6.9,5.5,2.6).curveTo(6.1,1.3,6.5,0).curveTo(6.8,-0.9,6.8,-1.7).curveTo(6.8,-3.9,5.4,-5.2).curveTo(3.7,-6.1,0.2,-6.6).curveTo(0.1,-6.6,0,-6.6).closePath().moveTo(0.4,-8.9).curveTo(0.9,-9,1.6,-8.8).curveTo(4.1,-8.5,6.1,-7.1).curveTo(8.9,-5.1,8.9,-1.9).curveTo(8.9,0.2,7.2,3.9).curveTo(4.8,8.9,1.1,8.9).curveTo(1.1,8.9,1,8.9).lineTo(0.3,8.9).curveTo(-0.3,8.9,-0.8,8.8).lineTo(-0.8,8.9).curveTo(-1.1,8.7,-1.6,8.7).curveTo(-1.7,8.7,-1.8,8.7).curveTo(-5.9,7.9,-7.5,4.4).curveTo(-7.6,4.2,-7.7,4).curveTo(-8.9,2.2,-8.9,0.3).curveTo(-8.9,-4.2,-6.1,-6.7).curveTo(-3.7,-8.9,0,-8.9).curveTo(0.2,-8.9,0.4,-8.9).closePath();
	this.shape_368.setTransform(0.3,-22.1);

	this.shape_369 = new cjs.Shape();
	this.shape_369.graphics.beginFill("#000000").beginStroke().moveTo(8.2,-5.3).curveTo(8.9,-4.2,8.9,-3).curveTo(8.9,-2,8.9,-1).curveTo(8.8,2.5,8,4).curveTo(6.7,6.7,1.7,9.5).lineTo(-0.5,9.5).curveTo(-2.3,9,-3.8,7.9).curveTo(-6,6.7,-7.3,4.1).curveTo(-7.3,4.1,-7.3,4).curveTo(-8.9,1.6,-8.9,-0.3).curveTo(-8.9,-2.7,-7.6,-4.6).curveTo(-7.4,-4.9,-7.3,-5.2).curveTo(-6.4,-6.3,-5,-7.3).curveTo(-4.1,-7.8,-3,-8.4).curveTo(-2.3,-8.7,-1.4,-9.1).curveTo(0.3,-9.8,2.2,-9.3).curveTo(4.4,-9.2,6,-8).curveTo(7.5,-7,8.2,-5.3).closePath().moveTo(4.3,-6.2).curveTo(3.9,-6.4,3.6,-6.6).curveTo(1.7,-7.1,-1,-7.2).curveTo(-1.6,-7,-2.2,-6.8).curveTo(-4.9,-4.4,-5.4,-3.8).curveTo(-7,-2,-7,-0.4).curveTo(-7,-0.3,-7,-0.2).curveTo(-7,-0.1,-7,-0).curveTo(-6.9,1.2,-4.7,4).curveTo(-2.8,6.5,-1.1,7.2).lineTo(1.7,7.2).curveTo(3.7,6.8,5.7,3).curveTo(6.4,1.6,6.8,0.3).curveTo(7,-0.8,7,-1.9).curveTo(7,-3.4,6.8,-4.2).curveTo(6,-5,4.3,-6.2).closePath();
	this.shape_369.setTransform(0.1,-21.4);

	this.shape_370 = new cjs.Shape();
	this.shape_370.graphics.beginFill("#FFFFFF").beginStroke().moveTo(4.3,-6.1).curveTo(6,-5,6.8,-4.2).curveTo(7,-3.3,7,-1.9).curveTo(7,-0.8,6.8,0.3).curveTo(6.4,1.6,5.7,3).curveTo(3.7,6.8,1.7,7.2).lineTo(-1.1,7.2).curveTo(-2.8,6.5,-4.7,4.1).curveTo(-6.9,1.3,-7,-0).curveTo(-7,-0.1,-7,-0.2).curveTo(-7,-0.3,-7,-0.3).curveTo(-6.9,-2,-5.4,-3.8).curveTo(-4.8,-4.4,-2.2,-6.8).curveTo(-1.6,-7,-1,-7.2).curveTo(1.8,-7.1,3.6,-6.6).curveTo(4,-6.4,4.3,-6.1).closePath();
	this.shape_370.setTransform(0,-21.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_364},{t:this.shape_363}]}).to({state:[{t:this.shape_366},{t:this.shape_365}]},5).to({state:[{t:this.shape_368},{t:this.shape_367}]},5).to({state:[{t:this.shape_370},{t:this.shape_369}]},5).wait(5));
...
(lib.mcPlayer_running_head = function(mode,startPosition,loop) {
	...
	this.shape_371.setTransform(8.2,-21.8);

	this.shape_372 = new cjs.Shape();
	this.shape_372.graphics.beginFill("#000000").beginStroke().moveTo(-6.4,-3.5).curveTo(-7.4,0.7,-7.4,1.5).curveTo(-7.4,1.9,-7.2,2.3).curveTo(-7,2.5,-7,2.7).curveTo(-6.9,2.7,-6.9,2.7).curveTo(-5.6,5.5,-3.6,6.6).curveTo(-3.2,6.4,-3,6.9).curveTo(-2,7.3,-0.8,7.3).lineTo(4.7,7.3).curveTo(6.7,4.8,7,3.5).curveTo(7.2,3,7.2,0.2).curveTo(7.2,-2.6,6.7,-3.9).curveTo(5.6,-6.9,2,-6.9).curveTo(0.2,-6.9,-1.4,-7).curveTo(-1.9,-6.8,-2.4,-6.6).curveTo(-6,-4.8,-6.4,-3.5).closePath().moveTo(-0.5,-9.2).curveTo(-0.2,-9.2,0.1,-9.1).curveTo(0.1,-9.2,0.1,-9.3).curveTo(0.5,-9.3,0.8,-9.3).curveTo(0.8,-9.2,0.8,-9.2).lineTo(0.8,-9.3).curveTo(6.8,-8.7,8.6,-4.9).curveTo(9.2,-3.6,9.2,-1.8).curveTo(9.1,-0.1,9.1,0).curveTo(9.4,2.6,8.7,4.8).curveTo(7.3,9.3,2,9.3).curveTo(-0.9,9.3,-3.1,8.5).curveTo(-3.6,7.9,-4.6,7.8).lineTo(-4.6,7.8).curveTo(-6.7,6.6,-8.1,4.5).curveTo(-9.2,4.2,-9.2,1.5).curveTo(-9.2,-6.1,-4.1,-8.5).curveTo(-2.3,-9.3,-0.5,-9.2).closePath();
	this.shape_372.setTransform(8.3,-22);

	this.shape_373 = new cjs.Shape();
	this.shape_373.graphics.beginFill("#FFFFFF").beginStroke().moveTo(5.8,-4.1).curveTo(6.9,-3.2,6.9,-1.1).curveTo(7.1,0.7,6.1,2.5).curveTo(4.1,6.1,-2.4,6.1).curveTo(-3.7,6.1,-5.4,4.4).curveTo(-7,2.8,-7,2).curveTo(-7,1.2,-5.3,-1.9).curveTo(-3.5,-5.2,-2.1,-6.1).curveTo(3.9,-5.6,5.8,-4.1).closePath();
	this.shape_373.setTransform(7.4,-19.8);

	this.shape_374 = new cjs.Shape();
	this.shape_374.graphics.beginFill("#000000").beginStroke().moveTo(1,-8).curveTo(5.5,-7.6,7.5,-4.9).curveTo(8.8,-3.2,8.8,-1.2).curveTo(8.8,1.6,7.6,3.9).curveTo(5.5,8.2,0.1,8.2).curveTo(-1.4,8.2,-2.7,7.9).curveTo(-2.7,8,-2.7,8).curveTo(-2.7,8.1,-2.8,8.1).curveTo(-3.3,7.7,-4.1,7.7).curveTo(-4.1,7.6,-4.1,7.6).curveTo(-6.4,6.9,-7.7,5.2).curveTo(-8.8,3.7,-8.8,2).curveTo(-8.8,0.4,-8.5,-0.3).curveTo(-7.7,-2.2,-7.4,-3.3).curveTo(-7,-4.7,-5.9,-5.9).curveTo(-5.8,-6,-5,-6.6).curveTo(-4.3,-7.1,-4.1,-7.2).curveTo(-3.1,-7.9,-3,-7.9).curveTo(-0.2,-8.3,0.6,-8.1).curveTo(0.2,-8,-0.1,-8).curveTo(0.5,-8,1,-8).curveTo(1,-7.9,1,-7.8).curveTo(1,-7.9,1,-8).closePath().moveTo(5.8,-4).curveTo(3.9,-5.5,-2.1,-6.1).curveTo(-3.5,-5.2,-5.3,-1.8).curveTo(-7,1.2,-7,2).curveTo(-7,2.8,-5.4,4.4).curveTo(-3.7,6.2,-2.4,6.2).curveTo(4.1,6.2,6.1,2.6).curveTo(7.1,0.8,6.9,-1.1).curveTo(6.9,-3.1,5.8,-4).closePath();
	this.shape_374.setTransform(7.4,-19.8);

	this.shape_375 = new cjs.Shape();
	this.shape_375.graphics.beginFill("#FFFFFF").beginStroke().moveTo(7.9,-0).curveTo(7.9,6.3,0.5,6.3).curveTo(-4.4,6.3,-6.6,3.9).curveTo(-7.9,2.3,-7.9,0.8).curveTo(-7.9,-1.2,-7.1,-3.3).curveTo(-5.8,-6.7,-3.2,-6.3).curveTo(3.7,-6.5,6.4,-3.9).curveTo(7.9,-2.4,7.9,-0).closePath();
	this.shape_375.setTransform(10.8,-20);

	this.shape_376 = new cjs.Shape();
	this.shape_376.graphics.beginFill("#000000").beginStroke().moveTo(6.4,-6.9).curveTo(9.8,-4.1,9.8,0.3).curveTo(9.8,2.9,8.6,4.9).curveTo(6.4,8.5,0.7,8.5).curveTo(-1.9,8.5,-3.8,8).curveTo(-3.8,8.1,-3.9,8.2).curveTo(-4.4,7.6,-5.4,7.4).curveTo(-7.4,6.5,-8.5,5).curveTo(-9.8,3.2,-9.8,1.1).curveTo(-9.8,-3.4,-7.6,-5.9).curveTo(-3.6,-10.5,6.4,-6.9).closePath().moveTo(7.9,0.2).curveTo(7.9,-2.2,6.4,-3.7).curveTo(3.7,-6.3,-3.2,-6.1).curveTo(-5.8,-6.5,-7.1,-3.1).curveTo(-7.9,-1,-7.9,1).curveTo(-7.9,2.5,-6.6,4.1).curveTo(-4.4,6.5,0.5,6.5).curveTo(7.9,6.5,7.9,0.2).closePath();
	this.shape_376.setTransform(10.8,-20.2);

	this.shape_377 = new cjs.Shape();
	this.shape_377.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,5.8).curveTo(-8.4,3.4,-8.4,0.4).curveTo(-8.4,-0.2,-8.2,-1.3).curveTo(-7.8,-3.1,-7,-4.5).curveTo(-4.6,-8.8,0.6,-7.5).curveTo(1.7,-6.4,5.6,-4.3).curveTo(8.4,-2.8,8.4,-1.6).curveTo(8.3,0.8,7.3,3.1).curveTo(5.3,7.8,1.1,7.8).curveTo(-1.1,7.8,-4.4,5.8).closePath();
	this.shape_377.setTransform(12.3,-19.4);

	this.shape_378 = new cjs.Shape();
	this.shape_378.graphics.beginFill("#000000").beginStroke().moveTo(0,-9.4).curveTo(4,-9,7.1,-6.9).curveTo(10.3,-4.6,10.3,-1.9).curveTo(10,1.2,8.7,3.9).curveTo(6.1,9.4,1.3,9.4).curveTo(-1.6,9.4,-4.2,7.9).curveTo(-4.2,8,-4.3,8.1).curveTo(-4.4,7.8,-4.6,7.6).curveTo(-5.2,7,-5.8,6.8).curveTo(-7,5.9,-8,4.9).curveTo(-10.3,3.4,-10.3,0.2).curveTo(-10.3,-5.1,-7.1,-7.6).curveTo(-4.3,-9.8,0,-9.4).closePath().moveTo(-4.4,5.5).curveTo(-1.1,7.4,1.1,7.4).curveTo(5.3,7.4,7.3,2.8).curveTo(8.3,0.4,8.4,-2).curveTo(8.4,-3.1,5.6,-4.7).curveTo(1.7,-6.8,0.6,-7.8).curveTo(-4.6,-9.1,-7,-4.8).curveTo(-7.8,-3.5,-8.2,-1.7).curveTo(-8.4,-0.5,-8.4,0).curveTo(-8.4,3.1,-4.4,5.5).closePath();
	this.shape_378.setTransform(12.3,-19.1);

	this.shape_379 = new cjs.Shape();
	this.shape_379.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.7,-3.3).curveTo(-5.5,-6.8,-2.8,-7.6).curveTo(2.1,-7.6,5.1,-3.6).curveTo(7.4,-0.6,7.4,2).curveTo(7.4,4.1,7.1,4.7).curveTo(6.2,6.3,2.7,7.6).lineTo(-0.9,7.6).curveTo(-5.8,6.6,-7,4.7).curveTo(-7.4,4.1,-7.4,1.8).curveTo(-7.4,-1,-6.7,-3.3).closePath();
	this.shape_379.setTransform(11.8,-22.3);

	this.shape_380 = new cjs.Shape();
	this.shape_380.graphics.beginFill("#000000").beginStroke().moveTo(0,-9.4).curveTo(3.7,-8.8,6.4,-5.7).curveTo(9.3,-2.4,9.3,1.9).curveTo(9.3,5,8.7,6.2).curveTo(7,9.5,0.9,9.5).curveTo(-2.1,9.5,-4.3,8.8).curveTo(-4.8,8.4,-5.7,8.3).lineTo(-5.7,8.2).curveTo(-7.4,7.3,-8.4,5.8).curveTo(-9.6,3.9,-9.3,1.7).curveTo(-9.3,-4.5,-6.4,-7.5).curveTo(-3.9,-10,0,-9.4).closePath().moveTo(-6.7,-3.4).curveTo(-7.4,-1.2,-7.4,1.7).curveTo(-7.4,3.9,-7,4.6).curveTo(-5.8,6.5,-0.9,7.5).lineTo(2.7,7.5).curveTo(6.2,6.1,7.1,4.6).curveTo(7.4,3.9,7.4,1.8).curveTo(7.4,-0.7,5.1,-3.8).curveTo(2.1,-7.8,-2.8,-7.8).curveTo(-5.5,-7,-6.7,-3.4).closePath();
	this.shape_380.setTransform(11.8,-22.1);

	this.shape_381 = new cjs.Shape();
	this.shape_381.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.9,-5.2).curveTo(-2.9,-6.7,0,-6.4).curveTo(2.9,-6.1,4.9,-4.2).curveTo(7.2,-2,7.2,1.3).curveTo(7.2,4.2,6.3,5.2).curveTo(5.1,6.5,1.7,6.5).curveTo(-3.7,6.5,-5.9,3.5).curveTo(-7.2,1.7,-7.2,-0.5).curveTo(-7.2,-3.6,-4.9,-5.2).closePath();
	this.shape_381.setTransform(12.8,-20.1);

	this.shape_382 = new cjs.Shape();
	this.shape_382.graphics.beginFill("#000000").beginStroke().moveTo(2.7,-7.8).curveTo(9.1,-7.2,9.1,1.1).curveTo(9.1,3.8,8.3,5.2).curveTo(6.7,8.3,1.8,8.3).curveTo(-1.4,8.3,-3.7,7.4).lineTo(-3.7,7.4).curveTo(-4.1,7,-4.8,6.9).curveTo(-6.7,5.9,-7.8,4.1).curveTo(-9.1,1.9,-9.1,-0.4).curveTo(-9.1,-3.7,-7.4,-5.7).curveTo(-4.5,-9.4,2.7,-7.8).closePath().moveTo(-4.9,-5.4).curveTo(-7.2,-3.8,-7.2,-0.7).curveTo(-7.2,1.6,-5.9,3.3).curveTo(-3.7,6.3,1.7,6.3).curveTo(5.1,6.3,6.3,5.1).curveTo(7.2,4,7.2,1.2).curveTo(7.2,-2.2,4.9,-4.3).curveTo(2.9,-6.3,0,-6.6).curveTo(-2.9,-6.9,-4.9,-5.4).closePath();
	this.shape_382.setTransform(12.8,-20);

	this.shape_383 = new cjs.Shape();
	this.shape_383.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0,-6.5).curveTo(2.8,-6,5,-4.3).curveTo(7.3,-2.6,7.3,-0.8).curveTo(7.3,0.7,6.4,3.1).curveTo(5.3,5.9,3.8,6.6).lineTo(-1,6.6).curveTo(-4.9,5.5,-6.3,3.3).curveTo(-7.3,2,-7.3,-0.2).curveTo(-7.3,-7.7,0,-6.5).closePath();
	this.shape_383.setTransform(10.5,-22);

	this.shape_384 = new cjs.Shape();
	this.shape_384.graphics.beginFill("#000000").beginStroke().moveTo(0,-6.5).curveTo(-7.3,-7.7,-7.3,-0.2).curveTo(-7.3,2,-6.3,3.3).curveTo(-4.9,5.5,-1,6.6).lineTo(3.8,6.6).curveTo(5.3,5.9,6.4,3.1).curveTo(7.3,0.7,7.3,-0.8).curveTo(7.3,-2.6,5,-4.3).curveTo(2.8,-6,0,-6.5).closePath().moveTo(0,-8.6).curveTo(3.7,-8.3,6.4,-6.2).curveTo(9.2,-3.9,9.2,-0.8).curveTo(9.2,2,8.3,4.1).curveTo(6.4,8.6,1.4,8.6).curveTo(-0.5,8.6,-2.1,8.3).curveTo(-2.1,8.3,-2.1,8.3).curveTo(-2.4,8.3,-2.6,8.2).curveTo(-3.1,8,-3.9,7.9).curveTo(-3.8,7.8,-3.7,7.7).curveTo(-6.1,6.7,-7.6,4.5).curveTo(-9.2,2.2,-9.2,-0).curveTo(-9.2,-4.7,-6.3,-7).curveTo(-3.8,-8.9,0,-8.6).closePath();
	this.shape_384.setTransform(10.5,-22);

	this.shape_385 = new cjs.Shape();
	this.shape_385.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.8,4.9).curveTo(-7.9,3.2,-7.9,1.6).curveTo(-7.9,-1.3,-7.2,-3).curveTo(-6,-5.5,-2.7,-7.4).curveTo(5.8,-4.7,7.1,-3.8).curveTo(7.9,-3.2,7.9,-0.3).curveTo(7.9,4.3,5.2,6).curveTo(3,7.4,-2.1,7.4).curveTo(-5.2,7.4,-6.8,4.9).closePath();
	this.shape_385.setTransform(13.3,-19);

	this.shape_386 = new cjs.Shape();
	this.shape_386.graphics.beginFill("#000000").beginStroke().moveTo(10.5,-20.7).curveTo(10.9,-20.5,12.2,-20.5).curveTo(14.2,-20.5,14.7,-17.8).curveTo(14.8,-17,14.8,-14.4).curveTo(14.9,-11.7,13.8,-9.3).curveTo(11.7,-4.6,5.8,-4.6).curveTo(2.8,-4.6,0.7,-5.3).curveTo(0.6,-5.2,0.6,-5.1).curveTo(0.3,-5.3,-0.1,-5.3).curveTo(-0.5,-5.9,-1.3,-6.1).curveTo(-4.8,-8,-4.8,-12.6).curveTo(-4.8,-14,-4,-16.5).curveTo(-3,-19.6,-1.6,-20.6).curveTo(-0.4,-21.5,2,-23.6).curveTo(4.2,-25,6.6,-22.9).curveTo(6.9,-22.7,10.5,-20.7).closePath().moveTo(-1.8,-9.1).curveTo(-0.2,-6.6,2.9,-6.6).curveTo(8,-6.6,10.2,-8).curveTo(12.9,-9.7,12.9,-14.3).curveTo(12.9,-17.2,12.1,-17.8).curveTo(10.8,-18.7,2.3,-21.4).curveTo(-1,-19.5,-2.2,-17).curveTo(-2.9,-15.3,-2.9,-12.4).curveTo(-2.9,-10.8,-1.8,-9.1).closePath().moveTo(-14.8,24.2).curveTo(-14.7,24,-14.6,23.9).curveTo(-14.6,23.9,-14.6,24).curveTo(-14.7,24.1,-14.8,24.2).closePath();
	this.shape_386.setTransform(8.3,-5);

	this.shape_387 = new cjs.Shape();
	this.shape_387.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.7,-6).curveTo(-3.4,-7.7,0,-7.1).curveTo(3.3,-6.6,5.7,-4.5).curveTo(8.3,-2.2,8.3,0.5).curveTo(8.3,3.3,7.3,4.6).curveTo(4.9,7.5,-2.2,7.3).curveTo(-8.3,2.6,-8.3,0.5).curveTo(-8.3,-4,-5.7,-6).closePath();
	this.shape_387.setTransform(13.2,-19.2);

	this.shape_388 = new cjs.Shape();
	this.shape_388.graphics.beginFill("#000000").beginStroke().moveTo(2,-10.2).curveTo(6.1,-9.6,9,-7).curveTo(12.2,-4.2,12.2,-0.5).curveTo(12.2,2.6,11.4,4.1).curveTo(9.9,6.6,5.3,8.3).lineTo(-0.7,8.3).curveTo(-1.6,7.7,-2.4,7.1).lineTo(-2.4,7.1).curveTo(-2.7,7,-3.1,6.9).curveTo(-3.6,6.2,-4.2,5.9).curveTo(-4.2,5.8,-4.1,5.8).curveTo(-8.2,2.4,-8.2,-0.6).curveTo(-8.2,-6,-5,-8.5).curveTo(-2.2,-10.7,2,-10.2).closePath().moveTo(-3.7,-7).curveTo(-6.3,-5,-6.3,-0.5).curveTo(-6.3,1.6,-0.2,6.3).curveTo(6.9,6.5,9.3,3.6).curveTo(10.3,2.3,10.3,-0.5).curveTo(10.3,-3.2,7.7,-5.5).curveTo(5.3,-7.6,2,-8.1).curveTo(-1.4,-8.7,-3.7,-7).closePath().moveTo(-12.2,10.3).lineTo(-12.2,10.3).lineTo(-12.2,10.3).closePath();
	this.shape_388.setTransform(11.2,-18.2);

	this.shape_389 = new cjs.Shape();
	this.shape_389.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-7.8,0.8).curveTo(-7.8,-1.1,-7.2,-3.6).curveTo(-6.5,-6.4,-5.4,-7.3).curveTo(7.8,-7.1,7.8,-2.1).curveTo(7.8,0.4,6.7,2.4).curveTo(5.7,4.1,2.6,7.3).lineTo(-2,7.3).curveTo(-2.4,7.1,-4.4,7).curveTo(-7.8,5.5,-7.8,0.8).closePath();
	this.shape_389.setTransform(13.2,-18.7);

	this.shape_390 = new cjs.Shape();
	this.shape_390.graphics.beginFill("#000000").beginStroke().moveTo(2.9,-8.6).curveTo(9.8,-6.3,9.8,-1.7).curveTo(9.8,1.1,8.3,4.3).curveTo(5.8,9.6,0.4,9.6).curveTo(-2.3,9.6,-4.3,9.1).curveTo(-4.3,9.1,-4.3,9.2).curveTo(-4.6,8.9,-5.1,8.9).curveTo(-5.5,8.6,-6,8.4).curveTo(-8.1,7.4,-9,5.5).curveTo(-10.1,3.5,-9.6,1.2).curveTo(-9.6,-0.7,-8.9,-3.6).curveTo(-8.1,-7.1,-7.1,-8).curveTo(-3.8,-10.9,2.9,-8.6).closePath().moveTo(-7.7,1.1).curveTo(-7.7,5.8,-4.4,7.3).curveTo(-2.4,7.4,-2,7.6).lineTo(2.6,7.6).curveTo(5.7,4.4,6.7,2.7).curveTo(7.9,0.8,7.9,-1.7).curveTo(7.9,-6.8,-5.4,-6.9).curveTo(-6.4,-6.1,-7.1,-3.2).curveTo(-7.7,-0.8,-7.7,1.1).closePath();
	this.shape_390.setTransform(13.1,-19);

	this.shape_391 = new cjs.Shape();
	this.shape_391.graphics.beginFill("#FFFFFF").beginStroke().moveTo(0.3,-7.9).lineTo(2.5,-7.9).curveTo(4,-6.5,6.8,-5).curveTo(8.1,-4.4,8.1,-2.6).curveTo(8.1,-0.4,5.9,2.9).curveTo(3.7,6.4,1.1,7.9).lineTo(-2.7,7.9).curveTo(-4.1,7.9,-6,5.9).curveTo(-8,3.7,-8,1.6).curveTo(-8,-1.7,-6.8,-3.5).curveTo(-4.9,-6.3,0.3,-7.9).closePath();
	this.shape_391.setTransform(13,-19.5);

	this.shape_392 = new cjs.Shape();
	this.shape_392.graphics.beginFill("#000000").beginStroke().moveTo(0,-9.6).curveTo(4,-9.9,6.9,-8.1).curveTo(10,-6.1,10,-2.7).curveTo(9.7,0.6,8.2,3.7).curveTo(5.2,9.7,-0.7,9.7).curveTo(-2.6,9.7,-4.2,9.2).curveTo(-4.8,8.9,-5.7,8.9).curveTo(-5.8,8.8,-6,8.8).curveTo(-6.2,8.6,-6.5,8.4).curveTo(-6.5,8.4,-6.4,8.3).curveTo(-8.1,7.4,-9,5.7).curveTo(-10.1,3.7,-9.9,1.5).curveTo(-9.9,-3.6,-6.8,-6.6).curveTo(-4.1,-9.2,0,-9.6).closePath().moveTo(0.3,-8.1).curveTo(-4.9,-6.5,-6.8,-3.7).curveTo(-8,-1.9,-8,1.4).curveTo(-8,3.5,-6,5.7).curveTo(-4.1,7.7,-2.7,7.7).lineTo(1.1,7.7).curveTo(3.7,6.2,6,2.7).curveTo(8.1,-0.6,8.1,-2.8).curveTo(8.1,-4.6,6.8,-5.2).curveTo(4,-6.7,2.5,-8.1).closePath();
	this.shape_392.setTransform(12.9,-19.3);

	this.shape_393 = new cjs.Shape();
	this.shape_393.graphics.beginFill("#FFFFFF").beginStroke().moveTo(7.5,3.1).curveTo(6.2,4.9,2.7,7.1).lineTo(-3.6,7.1).curveTo(-6,4.8,-7.9,3.2).curveTo(-8.7,2.4,-8.7,0.2).curveTo(-8.7,-2.9,-7.5,-4.3).curveTo(-5.1,-7.3,2.4,-7.1).curveTo(5.8,-6.1,7.4,-4.1).curveTo(8.7,-2.6,8.7,-0.8).curveTo(8.7,1.4,7.5,3.1).closePath();
	this.shape_393.setTransform(12.6,-19.5);

	this.shape_394 = new cjs.Shape();
	this.shape_394.graphics.beginFill("#000000").beginStroke().moveTo(0,-15.7).curveTo(4.2,-15.2,7.3,-12.8).curveTo(10.6,-10.2,10.6,-7).curveTo(10.6,-4,9.3,-2.1).curveTo(7.6,0.4,3.2,2.8).lineTo(-3.4,2.8).curveTo(-3.9,2.5,-4.4,2.3).curveTo(-4.8,1.8,-5.3,1.6).curveTo(-8,-0.8,-10,-2.3).curveTo(-10.6,-3,-10.6,-6.1).curveTo(-10.6,-11.5,-7.3,-14).curveTo(-4.4,-16.2,0,-15.7).closePath().moveTo(7.5,-3.2).curveTo(8.7,-4.8,8.7,-7).curveTo(8.7,-8.9,7.4,-10.4).curveTo(5.8,-12.3,2.4,-13.3).curveTo(-5.1,-13.5,-7.5,-10.5).curveTo(-8.7,-9.1,-8.7,-6).curveTo(-8.7,-3.8,-7.9,-3).curveTo(-6,-1.5,-3.6,0.8).lineTo(2.7,0.8).curveTo(6.2,-1.4,7.5,-3.2).closePath().moveTo(-5.3,15.7).curveTo(-5.2,15.7,-5.2,15.7).curveTo(-5.2,15.7,-5.2,15.7).closePath();
	this.shape_394.setTransform(12.6,-13.2);

	this.shape_395 = new cjs.Shape();
	this.shape_395.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-0.5,-7.7).curveTo(2.5,-7.5,4.9,-5.9).curveTo(7.4,-4.2,7.6,-2.5).curveTo(7.9,0.6,7,3.3).curveTo(5,8.5,-1.5,7.7).curveTo(-3.7,5.7,-6.2,3.6).curveTo(-7.5,2.2,-7.6,-0.3).curveTo(-8.2,-8.5,-0.5,-7.7).closePath();
	this.shape_395.setTransform(10,-20.9);

	this.shape_396 = new cjs.Shape();
	this.shape_396.graphics.beginFill("#000000").beginStroke().moveTo(-0.4,-7.5).curveTo(-8.2,-8.2,-7.6,-0).curveTo(-7.4,2.4,-6.1,3.8).curveTo(-3.7,5.9,-1.5,8).curveTo(5.1,8.7,7,3.5).curveTo(8,0.9,7.6,-2.3).curveTo(7.5,-4,5,-5.6).curveTo(2.5,-7.2,-0.4,-7.5).closePath().moveTo(-0.6,-9.8).curveTo(3.2,-9.8,6.1,-7.8).curveTo(9.3,-5.6,9.5,-2.4).curveTo(9.8,1,8.9,3.8).curveTo(7.1,9.4,1.2,9.8).curveTo(-0.6,9.9,-2.2,9.4).lineTo(-2.2,9.5).curveTo(-2.4,9.4,-2.6,9.3).curveTo(-3.1,9,-3.8,8.7).curveTo(-3.8,8.7,-3.8,8.7).curveTo(-5.2,7.9,-6.4,6.4).curveTo(-9.3,3.3,-9.5,-0.1).curveTo(-9.9,-5,-7,-7.6).curveTo(-4.6,-9.8,-0.6,-9.8).closePath();
	this.shape_396.setTransform(10,-21.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_372},{t:this.shape_371}]}).to({state:[{t:this.shape_374},{t:this.shape_373}]},2).to({state:[{t:this.shape_376},{t:this.shape_375}]},2).to({state:[{t:this.shape_378},{t:this.shape_377}]},2).to({state:[{t:this.shape_380},{t:this.shape_379}]},2).to({state:[{t:this.shape_382},{t:this.shape_381}]},2).to({state:[{t:this.shape_384},{t:this.shape_383}]},2).to({state:[{t:this.shape_386},{t:this.shape_385}]},2).to({state:[{t:this.shape_388},{t:this.shape_387}]},2).to({state:[{t:this.shape_390},{t:this.shape_389}]},2).to({state:[{t:this.shape_392},{t:this.shape_391}]},2).to({state:[{t:this.shape_394},{t:this.shape_393}]},2).to({state:[{t:this.shape_396},{t:this.shape_395}]},2).wait(2));
...
(lib.mcFlybot_char = function() {
	...
	this.addChild(this.turret,this.body,this.shape_431,this.rotor);
}).prototype = p = new cjs.Container();
...
(lib.giftedclientlogin = function() {
	...
	this.shape_432.setTransform(-419.8,-179.8,1,1,0,0,0,-419.9,-179.9);

	this.addChild(this.shape_432,this.btnLogin,this.txtUser,this.txtPass,this.lblGifted,this.lblStatus,this.text_1,this.text,this.instance_37);
}).prototype = p = new cjs.Container();
...
(lib.ScrollArrowUp_upSkin = function() {
	...
	this.shape_433.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_433.setTransform(7.5,4.3);

	this.shape_434 = new cjs.Shape();
	this.shape_434.graphics.beginLinearGradientFill(["#5B5D5E","#B7BABC"],[0,1],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_434.setTransform(7.5,7);

	this.shape_435 = new cjs.Shape();
	this.shape_435.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_435.setTransform(7.5,7);

	this.addChild(this.shape_435,this.shape_434,this.shape_433,this.instance_38);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowUp_overSkin = function() {
	...
	this.shape_436.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-1,3.5,-1,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_436.setTransform(7.6,4.3);

	this.shape_437 = new cjs.Shape();
	this.shape_437.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_437.setTransform(7.5,7);

	this.shape_438 = new cjs.Shape();
	this.shape_438.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_438.setTransform(7.5,7);

	this.addChild(this.shape_438,this.shape_437,this.shape_436,this.instance_39);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowDown_upSkin = function() {
	...
	this.shape_439.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_439.setTransform(7.5,4.3);

	this.shape_440 = new cjs.Shape();
	this.shape_440.graphics.beginLinearGradientFill(["#5B5D5E","#B7BABC"],[0,1],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_440.setTransform(7.5,7);

	this.shape_441 = new cjs.Shape();
	this.shape_441.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_441.setTransform(7.5,7);

	this.addChild(this.shape_441,this.shape_440,this.shape_439,this.instance_40);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.ScrollArrowDown_overSkin = function() {
	...
	this.shape_442.graphics.beginLinearGradientFill(["rgba(238,238,238,0)","rgba(255,255,255,0.298)"],[0,1],-0.9,3.5,-0.9,-3.1).beginStroke().moveTo(-6.5,3.3).lineTo(-6.5,-3.3).lineTo(6.5,-3.3).lineTo(6.5,3.3).closePath();
	this.shape_442.setTransform(7.5,4.3);

	this.shape_443 = new cjs.Shape();
	this.shape_443.graphics.beginLinearGradientFill(["#0075BF","#009DFF"],[0,0.992],1,5.9,1,-6.9).beginStroke().moveTo(7.5,7).lineTo(7.5,-7).lineTo(-7.5,-7).lineTo(-7.5,7).closePath().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_443.setTransform(7.5,7);

	this.shape_444 = new cjs.Shape();
	this.shape_444.graphics.beginLinearGradientFill(["#E6E6E6","#FFFFFF"],[0,1],-1.4,7,-1.4,-6.5).beginStroke().moveTo(6.5,-6).lineTo(6.5,6).lineTo(-6.5,6).lineTo(-6.5,-6).closePath();
	this.shape_444.setTransform(7.5,7);

	this.addChild(this.shape_444,this.shape_443,this.shape_442,this.instance_41);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,15,14);
...
(lib.giftedclientcharScreen = function() {
	...
	this.shape_445.graphics.beginRadialGradientFill(["#9487B2","#523D83"],[0,1],0,0,0,0,0,118.1).beginStroke().moveTo(-82.4,-13.5).curveTo(-48.3,-19.1,0,-19.1).curveTo(48.3,-19.1,82.4,-13.5).curveTo(116.5,-7.8,116.5,0).curveTo(116.5,7.9,82.4,13.5).curveTo(48.3,19.1,0,19.1).curveTo(-48.3,19.1,-82.4,13.5).curveTo(-116.5,7.9,-116.5,0).curveTo(-116.5,-7.8,-82.4,-13.5).closePath();
	this.shape_445.setTransform(504.7,219.2);

	// Back
	this.instance_75 = new lib.mcCharScreen_bg("single",0);
	this.instance_75.setTransform(332.2,139.2,1,1,0,0,0,0,-139.1);

	this.addChild(this.instance_75,this.shape_445,this.btnHeadNext,this.btnHeadPrev,this.displayHead,this.text_2,this.btnSave,this.btnCancel,this.displayMain);
}).prototype = p = new cjs.Container();
